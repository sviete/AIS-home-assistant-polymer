(function () {
  ...
  function h() {
    var a = Fa(['<div class="cover-gradient" style=', "></div>"]);
    return (
      (h = function () {
        return a;
      }),
  ...
  function ea() {
    var a = Fa(['<span class="ellipsis">', "</span>"]);
    return (
      (ea = function () {
        return a;
      }),
  ...
  function ma() {
    var a = Fa(["<span class='mmp-dropdown__item__label'>", "</span>"]);
    return (
      (ma = function () {
        return a;
      }),
  ...
  function Ha(a) {
    for (var b, c = 1; c < arguments.length; c++)
      (b = null == arguments[c] ? {} : arguments[c]),
        c % 2
          ? Ga(Object(b), !0).forEach(function (c) {
              Ia(a, c, b[c]);
            })
          : Object.getOwnPropertyDescriptors
          ? Object.defineProperties(a, Object.getOwnPropertyDescriptors(b))
          : Ga(Object(b)).forEach(function (c) {
    ...
    return (function (a) {
      ...
      function (b, d) {
        ...
        function j(b, g) {
          var e = Math.sqrt,
            ...
            s = e(o * o + q * q) - l,
            t = e(a * a + c * c + r * r),
            f = e(t) > e(Ia(h)) + e(Ia(s)) ? e(t * t - h * h - s * s) : 0;
          return (
            (h /= 1),
            (s /= 1 * (1 + 0.045 * l)),
            (f /= 1 * (1 + 0.015 * l)),
      ...
      function (a, b, c) {
        ...
        a.exports = function (b, g, e, h) {
          ...
          for (var j = -1, k = g.length; ++j < k; ) {
            var c = g[j],
              m = h ? h(e[c], b[c], c, e, b) : void 0;
            void 0 === m && (m = b[c]), i ? f(e, c, m) : d(e, c, m);
          }
          return e;
        };
      },
      ...
      function (b, d, e) {
        ...
        var i = e(20),
          ...
          h = (function () {
            function b(a, c) {
              (this._src = a),
                (this.opts = l({}, c, b.DefaultOpts)),
                (this.opts.combinedFilter = m.combineFilters(
                  this.opts.filters
                ));
            }
            return (
        ...
        var f = e(168),
          ...
          c = f(function (b, c) {
            ...
            for (q && i(c[0], c[1], q) && (o = 1); ++e < o; )
              for (var s = c[e], l = j(s), h = -1, u = l.length; ++h < u; ) {
                var d = l[h],
                  f = b[d];
          ...
          function d(b) {
            ...
            if (
              ("border-box" === h.boxSizing &&
                (Y(m + i) !== d && (m -= p(h, "left", "right") + i),
                Y(n + k) !== e && (n -= p(h, "top", "bottom") + k)),
              !(function (a) {
                  ...
                  if (this.hasActive()) {
                    var a = this.callbackCtx_,
                      b = this.activeObservations_.map(function (a) {
                        return new m(a.target, a.broadcastRect());
                      });
      ...
      function (a, b, c) {
        ...
        a.exports = function (b, i, e, k) {
          ...
          for (; ++m < n; ) {
            ...
            if (!(a && c[2])) {
              var p = new g();
              if (k) var d = k(l, h, o, b, i, p);
              if (void 0 === d ? !j(h, l, 3, k, p) : !d) return !1;
            } else if (void 0 === l && !(o in b)) return !1;
          }
          return !0;
        };
      },
      ...
      function (b, d, e) {
        var h = e(27),
          ...
          s = e(41),
          g = Object.prototype.hasOwnProperty;
        b.exports = function (l, p, e, r, d, f) {
          var t = a(l),
            u = a(p),
            v = t ? "[object Array]" : q(l),
            z = u ? "[object Array]" : q(p),
            A =
          ...
          if (w && !A)
            return (
              f || (f = new h()),
              t || s(l) ? n(l, p, e, r, d, f) : i(l, p, v, e, r, d, f)
            );
          if (!(1 & e)) {
            var x = A && g.call(l, "__wrapped__"),
              k = B && g.call(p, "__wrapped__");
            if (x || k) {
              var C = x ? l.value() : l,
                j = k ? p.value() : p;
              return f || (f = new h()), d(C, j, e, r, f);
            }
          }
          return !!w && (f || (f = new h()), o(l, p, e, r, d, f));
        };
      },
      function (a, b, c) {
        function d(a) {
      ...
      function (b, d, e) {
        ...
        b.exports = function (b, c, l, r, s, u, h) {
          switch (l) {
            ...
            case "[object ArrayBuffer]":
              return b.byteLength == c.byteLength && u(new j(b), new j(c));
            case "[object Boolean]":
            case "[object Date]":
            case "[object Number]":
              return i(+b, +c);
      ...
      function (a, b, c) {
        ...
        a.exports = function (i, k, e, n, o, q) {
          var a = 1 & e,
            c = j(i),
            r = c.length;
          if (r != j(k).length && !a) return !1;
          for (var l, s = r; s--; )
            if (((l = c[s]), a ? !(l in k) : !d.call(k, l))) return !1;
          var t = q.get(i);
          ...
          for (var w = a; ++s < r; ) {
            var x = i[(l = c[s])],
              g = k[l];
            if (n) var v = a ? n(g, x, l, k, i, q) : n(x, g, l, i, k, q);
      ...
      function (j, q, e) {
        ...
        (k["[object Arguments]"] = k["[object Array]"] = k[
          ...
          (j.exports = function q(x, e, y, j, D, F) {
            var G,
              H = 1 & e,
              J = 2 & e;
            if ((y && (G = D ? y(x, j, D, F) : y(x)), void 0 !== G)) return G;
            if (!b(x)) return x;
            var E = s(x);
            if (!E) {
              var K = d(x),
              ...
              if (
                ...
                return J ? l(x, o(G, x)) : r(x, i(G, x));
            } else if (((G = f(x)), !H)) return c(x, G);
            F || (F = new B());
            var M = F.get(x);
            if (M) return M;
            F.set(x, G),
              v(x)
                ...
                : u(x) &&
                  x.forEach(function (a, b) {
                    G.set(b, q(a, e, y, b, x, F));
                  });
            var N = 4 & e ? (J ? p : h) : J ? keysIn : w,
              L = E ? void 0 : N(x);
            return (
              n(L || x, function (a, b) {
                L && (a = x[(b = a)]), A(G, b, q(a, e, y, b, x, F));
              }),
              G
            );
          });
              ...
              (b.prototype.split = function () {
                ...
                if (d === u) {
                  ...
                  for (
                    ...
                    for (s = 0, A = e; A <= q; A++)
                      for (C = r; C <= a; C++) s += f[j.getColorIndex(A, B, C)];
                    (t += s), (m[B] = t);
                  }
                else
                  for (
                    ...
                    for (s = 0, A = e; A <= q; A++)
                      for (B = i; B <= o; B++) s += f[j.getColorIndex(A, B, C)];
                    (t += s), (m[C] = t);
                  }
                for (
                ...
                return (function (b) {
                  ...
                  for (
                    k <= a
                      ? ((g = Fa(g - 1, ~~(E + a / 2))), (g = Ga(0, g)))
                      : ((g = Ga(f, ~~(E - 1 - k / 2))),
                        (g = Fa(G.dimension[e], g)));
                    !m[g];
      ...
      function (a, b, c) {
        ...
        (f.prototype.parse = function (c, f, i) {
          ...
          if (!s[b] && (x || (b && !g[b]))) {
            ...
            if (!Y)
              for (
                var C, Z = this.hostname.split(/\./), A = ((W = 0), Z.length);
                W < A;
                W++
              )
                if (((C = Z[W]), C && !C.match(n))) {
                  for (var _ = "", aa = 0, ba = C.length; aa < ba; aa++)
                    _ += 127 < C.charCodeAt(aa) ? "x" : C[aa];
                  if (!_.match(n)) {
                    var V = Z.slice(0, W),
                      N = Z.slice(W + 1),
                      L = C.match(/^([+a-z0-9A-Z_-]{0,63})(.*)$/);
          ...
          if (!d[v])
            for (W = 0, A = k.length; W < A; W++) {
              var F = k[W];
              if (-1 !== r.indexOf(F)) {
                var R = encodeURIComponent(F);
                R === F && (R = escape(F)), (r = r.split(F).join(R));
              }
            }
          var da = r.indexOf("#");
          ...
          if (
            (-1 === q
              ? f && ((this.search = ""), (this.query = {}))
              : ((this.search = r.substr(q)),
                (this.query = r.substr(q + 1)),
          ...
          (f.prototype.resolveObject = function (i) {
              ...
              return (
                J &&
                  ...
                  (Q =
                    ...
                    q.host.split("@")) &&
                    ((q.auth = Q.shift()), (q.host = q.hostname = Q.shift()))),
                (q.search = i.search),
                (q.query = i.query),
            ...
            return (
              J &&
                ((q.hostname = q.host = R ? "" : x.length ? x.shift() : ""),
                (Q =
                  !!(q.host && 0 < q.host.indexOf("@")) && q.host.split("@")) &&
                  ((q.auth = Q.shift()), (q.host = q.hostname = Q.shift()))),
              (b = b || (q.host && x.length)) && !R && x.unshift(""),
              x.length
                ? (q.pathname = x.join("/"))
      ...
      function (Ja, La, Ma) {
        function Na(b, d) {
          for (
            ...
            var p = g.currentNode;
            for (
              p.previousSibling === n && (n = null),
                d.has(p) && (m.push(p), null === n && (n = p)),
                null !== n && k++;
              void 0 !== i && i.index === j;

            )
              (i.index = null === n ? i.index - k : -1),
                (h = $a(e, h)),
                (i = e[h]);
          }
        ...
        function Oa(a) {
          ...
          var d = a.strings.join(Ra);
          return (
            (c = b.keyString.get(d)),
            void 0 === c &&
              ((c = new Ua(a, a.getTemplateElement())), b.keyString.set(d, c)),
        ...
        var Pa =
          ...
          Ra = "{{lit-".concat((Math.random() + "").slice(2), "}}"),
          Sa = "<!--".concat(Ra, "-->"),
          Ta = new RegExp("".concat(Ra, "|").concat(Sa));
        class Ua {
          constructor(a, b) {
            ...
            for (
              ...
              if (!(null !== v)) h.currentNode = g.pop();
                ...
                if (v.hasAttributes()) {
                  for (
                    var f = v.attributes, { length: n } = f, o = 0, p = 0;
                    p < n;
                    p++
                  )
                    Va(f[p].name, "$lit$") && o++;
                ...
                if (v.data === Ra) {
                  ...
                  (null !== v.previousSibling && j !== i) ||
                    (j++, F.insertBefore(Xa(), v)),
                    (i = j),
                    this.parts.push({ type: "node", index: j }),
                    null === v.nextSibling ? (v.data = "") : (e.push(v), j--),
                    k++;
                } else
                  for (var G = -1; -1 !== (G = v.data.indexOf(Ra, G + 1)); )
        ...
        var Va = (a, b) => {
          ...
          Wa = (a) => -1 !== a.index,
          Xa = () => document.createComment(""),
          Ya = /([ \x09\x0a\x0c\x0d])([^\0-\x1F\x7F-\x9F "'>=/]+)([ \x09\x0a\x0c\x0d]*=[ \x09\x0a\x0c\x0d]*(?:[^ \x09\x0a\x0c\x0d"'`<>=]*|"[^"]*|'[^']*))$/,
          Za = (a) => {
            for (
          ...
          bb = (a) => "function" == typeof a && _a.has(a),
          cb = {},
          db = {};
        class eb {
          constructor(a, b, c) {
          ...
          _clone() {
            ...
            return Pa && (document.adoptNode(d), customElements.upgrade(d)), d;
          }
        }
        var fb = " ".concat(Ra, " ");
        class gb {
          ...
          getHTML() {
            for (
              ...
              b +=
                null === h
                  ? f + (c ? fb : Sa)
                  : f.substr(0, h.index) + h[1] + h[2] + "$lit$" + h[3] + Ra;
            }
        ...
        var hb = (a) =>
          ...
          ib = (a) => Array.isArray(a) || (a && a[Symbol.iterator]);
        class jb {
          constructor(a, b, c) {
            (this.dirty = !0),
              (this.element = a),
          ...
          _getValue() {
            for (
              ...
              if (void 0 !== e) {
                var f = e.value;
                if (hb(f) || !ib(f)) c += "string" == typeof f ? f : f + "";
        ...
        class kb {
          ...
          setValue(a) {
            a === cb ||
              (hb(a) && a === this.value) ||
              ((this.value = a), bb(a) || (this.committer.dirty = !0));
          }
          commit() {
            for (; bb(this.value); ) {
              var a = this.value;
              (this.value = cb), a(this);
            }
            this.value !== cb && this.committer.commit();
          }
        }
        class lb {
          constructor(a) {
          ...
          appendInto(a) {
            (this.startNode = a.appendChild(Xa())),
              (this.endNode = a.appendChild(Xa()));
          }
          insertAfterNode(a) {
            (this.startNode = a), (this.endNode = a.nextSibling);
          }
          appendIntoPart(a) {
            a.__insert((this.startNode = Xa())),
              a.__insert((this.endNode = Xa()));
          }
          insertAfterPart(a) {
            a.__insert((this.startNode = Xa())),
          ...
          commit() {
            if (null !== this.startNode.parentNode) {
              for (; bb(this.__pendingValue); ) {
                var b = this.__pendingValue;
                (this.__pendingValue = cb), b(this);
              }
          ...
          __commitTemplateResult(a) {
            ...
            if (this.value instanceof eb && this.value.template === b)
              this.value.update(a.values);
            else {
              var c = new eb(b, a.processor, this.options),
                d = c._clone();
          ...
          clear() {
            var a =
              0 < arguments.length && arguments[0] !== void 0
                ? arguments[0]
                : this.startNode;
            Qa(this.startNode.parentNode, a.nextSibling, this.endNode);
          }
        }
        class mb {
          constructor(a, b, c) {
        ...
        var rb = (a) =>
          ...
          ub = new (class {
            handleAttributeExpressions(a, b, c, d) {
              var e = b[0];
              return "." === e
                ? new nb(a, b.slice(1), c).parts
                : "@" === e
                ? [new qb(a, b.slice(1), d.eventContext)]
                : "?" === e
                ? [new mb(a, b.slice(1), c)]
                : new jb(a, b, c).parts;
            }
        ...
        var vb = function (a) {
            for (
              ...
              c[d - 1] = arguments[d];
            return new gb(a, c, "html", ub);
          },
          wb = (a, b) => "".concat(a, "--").concat(b),
          xb = !0;
        ...
        var yb = (a) => (b) => {
            ...
            var f = b.strings.join(Ra);
            if (((e = d.keyString.get(f)), void 0 === e)) {
              var g = b.getTemplateElement();
              xb && window.ShadyCSS.prepareTemplateDom(g, a),
                (e = new Ua(b, g)),
                d.keyString.set(f, e);
            }
              ...
              ? (function (b, d) {
                  ...
                  for (
                    ...
                    for (
                      k++,
                        h.currentNode === e &&
                          ((j = Za(d)), e.parentNode.insertBefore(d, e));
                      -1 !== i && f[i].index === k;

                    ) {
                      if (0 < j) {
                        for (; -1 !== i; ) (f[i].index += j), (i = $a(f, i));
                        return;
                      }
                      i = $a(f, i);
                    }
        ...
        class Fb extends HTMLElement {
          ...
          static getPropertyOptions(a) {
            return (
              (this._classProperties && this._classProperties.get(a)) || Eb
            );
          }
          static finalize() {
          ...
          static _propertyValueToAttribute(a, b) {
            if (void 0 !== b.reflect) {
              var c = b.type,
                d = b.converter;
              return ((d && d.toAttribute) || Cb.toAttribute)(a, c);
            }
          }
          initialize() {
        ...
        var Jb = function (a) {
          ...
          var e = c.reduce(
            (b, c, d) =>
              b +
              ((a) => {
                if (a instanceof Ib) return a.cssText;
            ...
            if (
              (((a, b, c) => {
                ...
                void 0 === d &&
                  ...
                  tb.set(
                    b,
                    (d = new lb(Object.assign({ templateFactory: Oa }, c)))
                  ),
                  d.appendInto(b)),
                  d.setValue(a),
                  d.commit();
              })(b, a, Object.assign({ templateFactory: yb(f) }, e)),
              i)
            ) {
              var c = tb.get(a);
              tb.delete(a);
              var j = c.value instanceof eb ? c.value.template : void 0;
              Bb(f, a, j), Qa(d, d.firstChild), d.appendChild(a), tb.set(d, c);
            }
        ...
        var Nb = new WeakMap(),
          ...
          Qb = ab((a) => (b) => {
            ...
            for (var e in (void 0 === f &&
              ((d.cssText = c.strings.join(" ")), Pb.set(b, (f = new Set()))),
            f.forEach((b) => {
              b in a ||
                (f.delete(b),
          ...
          Tb = "mdi:chevron-down",
          Ub = { true: "mdi:volume-off", false: "mdi:volume-high" },
          Vb = "mdi:skip-next",
          Wb = { true: "mdi:pause", false: "mdi:play" },
          Xb = { true: "mdi:stop", false: "mdi:play" },
          Yb = [
            "entity",
            "_overflow",
            "break",
          ...
          bc = (a) => {
            ...
            var b = Ha(
              ...
              {},
              {
                hide: Ha(Ha({}, Sb), a.hide),
                speaker_group: Ha(
                  Ha({ show_group_count: !0, platform: "sonos" }, a.sonos),
                  a.speaker_group
                ),
                shortcuts: Ha({ label: "Przekieruj media na" }, a.shortcuts),
              }
            );
            return (
        ...
        class dc {
          ...
          get mediaInfo() {
            return $b
              .map((a) => Ha({ text: this.attr[a.attr], prefix: "" }, a))
              .filter((a) => a.text);
          }
          get hasProgress() {
            return (
          ...
          setMedia(a, b) {
            this.callService(a, "play_media", Ha({}, b));
          }
          playPause(a) {
          ...
          volumeUp(a) {
            this.supportsVolumeSet && 0 < this.config.volume_step
              ? this.callService(a, "volume_set", {
                  ...
                  volume_level: Fa(this.vol + this.config.volume_step / 100, 1),
                })
          ...
          volumeDown(a) {
            this.supportsVolumeSet && 0 < this.config.volume_step
              ? this.callService(a, "volume_set", {
                  entity_id: this.config.entity,
                  volume_level: Ga(this.vol - this.config.volume_step / 100, 0),
                })
          ...
          handleGroupChange(a, b, c) {
            var { platform: d } = this,
              e = { entity_id: b };
            if (c)
              switch (((e.master = this.config.entity), d)) {
                case ac:
              ...
              return d === ac
                ...
                : d === _b
                ? this.callService(a, "unsync", e, _b)
          ...
          toggleScript(a, b) {
            var c =
              2 < arguments.length && arguments[2] !== void 0
                ? arguments[2]
                : {};
            this.callService(a, b.split(".").pop(), Ha({}, c), "script");
          }
          toggleService(a, b) {
            var c =
              2 < arguments.length && arguments[2] !== void 0
            ...
            a.stopPropagation();
            var [d, e] = b.split(".");
            this.hass.callService(d, e, Ha({}, c));
          }
          callService(a, b, c) {
            var d =
            ...
            a.stopPropagation(),
              this.hass.callService(
                d,
                b,
                Ha(Ha({}, !e && { entity_id: this.config.entity }), c)
              );
          }
        }
        var ec = Jb(Ea()),
            ...
            Y(
              100 *
                (((a, b) => {
                  var c = hc(...a),
                    d = hc(...b);
                  return (Ga(c, d) + 0.05) / (Fa(c, d) + 0.05);
                })(a, b) +
                  Number.EPSILON)
            ) / 100,
          jc = (a) => {
            function b(a) {
              return e.has(a) || e.set(a, ic(d.rgb, a.rgb)), 4.5 < e.get(a);
            }
        ...
        var kc = {
          ...
          lc = (a, b) => b.split(".").reduce((a, b) => (a && a[b]) || null, a),
          mc = function (a, b, c) {
            var d =
                3 < arguments.length && arguments[3] !== void 0
                  ? arguments[3]
            ...
            class extends Lb {
              ...
              render() {
                return vb(
                  ...
                  this.icon
                    ? vb(qa(), Tb)
                    : vb(pa(), this.selected || this.label, Tb),
                  this.selectedId,
                  this.onChange,
                  this.items.map((a) =>
                    vb(
        ...
        customElements.define(
          ...
          class extends Lb {
            ...
            render() {
              return vb(
                ...
                this.showTime
                  ? vb(
                      $(),
                      nc(this.seekProgress || this.progress),
                      nc(this.duration)
                    )
                  : "",
                this.classes,
            ...
            calcProgress(a) {
              ...
              return Fa(Ga(b, 0.1), this.duration);
            }
            static get styles() {
              return Jb(Z());
            }
                ...
                return vb(
                  ...
                  a.controls
                    ...
                    : vb(
                        ...
                        a.next ? "" : vb(M(), (a) => this.player.next(a), Vb)
                      )
                );
              }
              renderVolControls(a) {
                  ...
                  switch (this.config.replace_mute) {
                    ...
                    case "play_pause":
                      return vb(
                        ...
                        Wb[this.player.isPlaying]
                      );
                    case "stop":
                      return vb(I(), (a) => this.player.stop(a), Xb.true);
                    case "play_stop":
                      return vb(
                        H(),
                        (a) => this.player.playStop(a),
                        Xb[this.player.isPlaying]
                      );
                    case "next":
                      return vb(G(), (a) => this.player.next(a), Vb);
                    default:
                      return this.player.supportsMute
                        ? vb(F(), (a) => this.player.toggleMute(a), Ub[a])
                        : void 0;
                  }
              }
              renderPlayButtons() {
                ...
                return vb(
                  ...
                  a.play_stop
                    ...
                    : vb(
                        z(),
                        (a) => this.handleStop(a),
                        a.play_pause ? Xb[this.player.isPlaying] : Xb.true
                      )
                );
              }
              handleStop(a) {
            ...
            class extends Lb {
              ...
              render() {
                return this.player.isUnavailable
                  ...
                  : vb(
                      ...
                      this.hasControls ? vb(v(), this.player, this.config) : "",
                      this.hasSource
                        ? vb(
                            u(),
                            this.player,
              ...
              get renderIdleView() {
                return this.player.isPaused
                  ? vb(q(), Wb[this.player.isPlaying], (a) =>
                      this.player.playPause(a)
                    )
                  : vb(
                      p(),
                      mc(this.hass, "state.idle", "state.media_player.idle")
                    );
              }
              static get styles() {
                return [fc, Jb(o())];
            ...
            class extends Lb {
                ...
                if (a) {
                  ...
                  (this._hass = a),
                    b &&
                      this.entity !== b &&
                      ((this.entity = b),
                      (this.player = new dc(a, this.config, b)),
                ...
                return (
                  ...
                  vb(
                    ...
                    !a.collapse && this.player.active
                      ? vb(m(), this.player, a, this.break)
                      : "",
                    this.player,
                    this.hass,
                    a.shortcuts,
                    a.tts ? vb(l(), a.tts, this.hass, this.player) : "",
                    this.hass,
                    this.edit,
                    a.speaker_group.entities,
                    this.player,
                    this.player.active && this.player.hasProgress
                      ? vb(k(), this.player, !this.config.hide.runtime)
                      : ""
                  )
                );
              }
                ...
                if (this.thumbnail || this.config.background) {
                  var a = {
                      backgroundImage:
                        ...
                        (this.thumbnail && "default" !== this.config.artwork)
                          ? this.thumbnail
                  ...
                  return vb(j(), Qb(a), this.prevThumbnail && vb(i(), Qb(b)));
                }
              }
              renderGradient() {
              ...
              renderIcon() {
                if (!this.config.hide.icon) {
                  ...
                  return vb(f(), a, this.computeIcon());
                }
              }
              renderEntityName() {
                if (!this.config.hide.name)
                  return vb(e(), this.name, this.speakerCount());
              }
              renderMediaInfo() {
                  ...
                  return vb(
                    ...
                    "scroll" === this.config.info
                      ? vb(
                          c(),
                          e.map((a) =>
                            vb(b(), "attr__" + a.attr, a.prefix + a.text)
                          )
                        )
                      : "",
                    e.map((b) => vb(a(), "attr__" + b.attr, b.prefix + b.text))
                  );
                }
              }
              speakerCount() {
              ...
              computeArtwork() {
                ...
                return Ka(function* () {
                  ...
                  return c && a.thumbnail;
                })();
              }
              computeIcon() {
                return this.config.icon
                  ? this.config.icon
                  : this.player.icon || "mdi:cast";
              }
              measureCard() {
