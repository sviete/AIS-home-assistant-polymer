(function () {
  ...
  function i() {
    var a = Ta(['<div class="cover-gradient" style=', "></div>"]);
    return (
      (i = function () {
        return a;
      }),
  ...
  function q() {
    var a = Ta([" <paper-item>", "</paper-item> "]);
    return (
      (q = function () {
        return a;
      }),
  ...
  function V() {
    var a = Ta([
      '\n      <span class="mmp-media-controls__volume__level">',
      "%</span>\n    ",
    ]);
    return (
      (V = function () {
  ...
  function qa() {
    var a = Ta(['<span class="ellipsis">', "</span>"]);
    return (
      (qa = function () {
        return a;
      }),
  ...
  function ya() {
    var a = Ta(["<span class='mmp-dropdown__item__label'>", "</span>"]);
    return (
      (ya = function () {
        return a;
      }),
  ...
  function Na() {
    var a = Ta(['<span class="master">(', ")</span>"]);
    return (
      (Na = function () {
        return a;
      }),
  ...
  function Va(a) {
    for (var b, c = 1; c < arguments.length; c++)
      (b = null == arguments[c] ? {} : arguments[c]),
        c % 2
          ? Ua(Object(b), !0).forEach(function (c) {
              Wa(a, c, b[c]);
            })
          : Object.getOwnPropertyDescriptors
          ? Object.defineProperties(a, Object.getOwnPropertyDescriptors(b))
          : Ua(Object(b)).forEach(function (c) {
    ...
    return (function (a) {
      ...
      function (b, d) {
        ...
        function g(a, b, d) {
          return (
            ...
            (d /= 255),
            (a =
              0.04045 < (a /= 255) ? c((a + 0.005) / 1.055, 2.4) : a / 12.92),
            (b = 0.04045 < b ? c((b + 0.005) / 1.055, 2.4) : b / 12.92),
            (d = 0.04045 < d ? c((d + 0.005) / 1.055, 2.4) : d / 12.92),
            [
              0.4124 * (a *= 100) + 0.3576 * (b *= 100) + 0.1805 * (d *= 100),
              0.2126 * a + 0.7152 * b + 0.0722 * d,
              0.0193 * a + 0.1192 * b + 0.9505 * d,
            ]
          );
        }
        function h(a, b, d) {
          return (
            (b /= 100),
            (d /= 108.883),
            (a = 0.008856 < (a /= 95.047) ? c(a, 1 / 3) : 7.787 * a + 16 / 116),
            [
              116 * (b = 0.008856 < b ? c(b, 1 / 3) : 7.787 * b + 16 / 116) -
                16,
              500 * (a - b),
              200 *
                (b - (d = 0.008856 < d ? c(d, 1 / 3) : 7.787 * d + 16 / 116)),
            ]
          );
        }
        function i(a, b, c) {
        ...
        function j(b, g) {
          var e = Math.sqrt,
            ...
            s = e(o * o + q * q) - r,
            t = e(a * a + c * c + l * l),
            f = e(t) > e(Xa(h)) + e(Xa(s)) ? e(t * t - h * h - s * s) : 0;
          return (
            (h /= 1),
            (s /= 1 * (1 + 0.045 * r)),
            (f /= 1 * (1 + 0.015 * r)),
        ...
        function a(a, b) {
          return j(i.apply(void 0, a), i.apply(void 0, b));
        }
        Object.defineProperty(d, "__esModule", { value: !0 }),
          (d.DELTAE94_DIFF_STATUS = {
            NA: 0,
            PERFECT: 1,
            CLOSE: 2,
            GOOD: 10,
          ...
          (d.hexToRgb = f),
          (d.rgbToHex = function (a, b, c) {
            return (
              "#" +
              (16777216 + (a << 16) + (b << 8) + c).toString(16).slice(1, 7)
            );
          }),
          (d.rgbToHsl = function (b, d, f) {
            (b /= 255), (d /= 255), (f /= 255);
            var g,
              h,
              j = Wa(b, d, f),
            ...
            if (j === k) g = h = 0;
              ...
              var a = j - k;
              switch (((h = 0.5 < l ? a / (2 - j - k) : a / (j + k)), j)) {
                case b:
                  g = (d - f) / a + (d < f ? 6 : 0);
                  break;
                case d:
          ...
          (d.hslToRgb = function (b, d, e) {
            ...
            if (0 === d) g = h = j = e;
              ...
              var k = 0.5 > e ? e * (1 + d) : e + d - e * d,
                a = 2 * e - k;
              (g = f(a, k, b + 1 / 3)),
                (h = f(a, k, b)),
                (j = f(a, k, b - 1 / 3));
            }
            return [255 * g, 255 * h, 255 * j];
          }),
          (d.rgbToXyz = g),
          (d.xyzToCIELab = h),
          (d.rgbToCIELab = i),
          (d.deltaE94 = j),
          (d.rgbDiff = a),
          (d.hexDiff = function (b, c) {
            return a(f(b), f(c));
          }),
          (d.getColorDiffStatus = function (a) {
            return a < d.DELTAE94_DIFF_STATUS.NA
              ? "N/A"
              : a <= d.DELTAE94_DIFF_STATUS.PERFECT
              ? "Perfect"
              : a <= d.DELTAE94_DIFF_STATUS.CLOSE
              ? "Close"
              : a <= d.DELTAE94_DIFF_STATUS.GOOD
              ? "Good"
              : a < d.DELTAE94_DIFF_STATUS.SIMILAR
              ? "Similar"
              : "Wrong";
          }),
          (d.getColorIndex = function (a, b, c) {
            return (a << (2 * d.SIGBITS)) + (b << d.SIGBITS) + c;
          });
      },
      function (a) {
        a.exports = function (a) {
      ...
      function (b, g, e) {
        var j = e(118),
          ...
          d = c(o),
          f = a;
        ((j && "[object DataView]" != f(new j(new ArrayBuffer(1)))) ||
          (k && "[object Map]" != f(new k())) ||
          (i && "[object Promise]" != f(i.resolve())) ||
          (n && "[object Set]" != f(new n())) ||
          (o && "[object WeakMap]" != f(new o()))) &&
          (f = function (b) {
            var f = a(b),
              e = "[object Object]" == f ? b.constructor : void 0,
              g = e ? c(e) : "";
            if (g)
              switch (g) {
                case l:
      ...
      function (a, b, c) {
        ...
        a.exports = function (a) {
          ...
          var b = a + "";
          return "0" == b && 1 / a == -1 / 0 ? "-0" : b;
        };
      },
      function (a, b, c) {
        var d = c(56),
          f = c(57);
        a.exports = function (b, g, e, h) {
          var i = !e;
          e || (e = {});
          for (var j = -1, k = g.length; ++j < k; ) {
            var c = g[j],
              l = h ? h(e[c], b[c], c, e, b) : void 0;
            void 0 === l && (l = b[c]), i ? f(e, c, l) : d(e, c, l);
          }
          return e;
        };
      },
      ...
      function (a, b, c) {
        ...
        var d = c(9),
          ...
          e = (function () {
            function a(a, b) {
              (this._rgb = a), (this._population = b);
            }
            return (
              (a.applyFilter = function (a, b) {
              ...
              Object.defineProperty(a.prototype, "rgb", {
                get: function () {
                  return this._rgb;
                },
                enumerable: !0,
              ...
              Object.defineProperty(a.prototype, "hsl", {
                get: function () {
                  if (!this._hsl) {
                    var a = this._rgb,
                      b = a[0],
              ...
              Object.defineProperty(a.prototype, "population", {
                get: function () {
              ...
              (a.prototype.getRgb = function () {
                return this._rgb;
              }),
              (a.prototype.getHsl = function () {
                return this.hsl;
              }),
              (a.prototype.getPopulation = function () {
                return this._population;
              }),
              (a.prototype.getHex = function () {
                return this.hex;
              }),
              (a.prototype.getYiq = function () {
                if (!this._yiq) {
                  var a = this._rgb;
                  this._yiq = (299 * a[0] + 587 * a[1] + 114 * a[2]) / 1e3;
                }
                return this._yiq;
              }),
              Object.defineProperty(a.prototype, "titleTextColor", {
                get: function () {
                  return (
                    this._titleTextColor ||
                      (this._titleTextColor =
                        200 > this.getYiq() ? "#fff" : "#000"),
                    this._titleTextColor
                  );
                },
                enumerable: !0,
              ...
              Object.defineProperty(a.prototype, "bodyTextColor", {
                get: function () {
                  return (
                    this._bodyTextColor ||
                      (this._bodyTextColor =
                        150 > this.getYiq() ? "#fff" : "#000"),
                    this._bodyTextColor
                  );
                },
                enumerable: !0,
              ...
              (a.prototype.getTitleTextColor = function () {
                return this.titleTextColor;
              }),
              (a.prototype.getBodyTextColor = function () {
      ...
      function (a, b, d) {
        (function (e) {
          var f = d(0),
            g = d(74),
            h = b && !b.nodeType && b,
            i = h && "object" == typeof e && e && !e.nodeType && e,
            j = i && i.exports === h ? f.Buffer : void 0,
            a = (j ? j.isBuffer : void 0) || g;
          e.exports = a;
        }.call(this, d(10)(a)));
      },
      function (a) {
        a.exports = function (a, b) {
          ...
          return (
            ...
            ("number" == c || ("symbol" != c && /^(?:0|[1-9]\d*)$/.test(a))) &&
            -1 < a &&
            0 == a % 1 &&
            a < b
          );
      ...
      function (a, b, c) {
        (function (d) {
          var e = c(40),
            f = b && !b.nodeType && b,
            g = f && "object" == typeof d && d && !d.nodeType && d,
            h = g && g.exports === f && e.process,
            i = (function () {
              try {
                var a = g && g.require && g.require("util").types;
      ...
      function (b, d, e) {
        var f =
          ...
          g =
            ...
            function (a) {
              ...
              if (null != a)
                for (var c in a)
                  Object.hasOwnProperty.call(a, c) && (b[c] = a[c]);
        ...
        var i = e(20),
          ...
          h = (function () {
            function b(a, c) {
              (this._src = a),
                (this.opts = m({}, c, b.DefaultOpts)),
                (this.opts.combinedFilter = l.combineFilters(
                  this.opts.filters
                ));
            }
            return (
              (b.from = function (a) {
                return new j.default(a);
              }),
              (b.prototype._process = function (a, b) {
                var c = b.quantizer,
                  d = b.generator;
                return (
                  a.scaleDown(b),
                  a
                    .applyFilter(b.combinedFilter)
                    .then(function (a) {
                      return c(a.data, b);
                    })
                    .then(function (a) {
                      return i.Swatch.applyFilter(a, b.combinedFilter);
                    })
                    .then(function (a) {
              ...
              (b.prototype.palette = function () {
                return this.swatches();
              }),
              (b.prototype.swatches = function () {
                return this._palette;
              }),
              (b.prototype.getPalette = function (a) {
                var b = this,
                  c = new this.opts.ImageClass(),
                  d = c
                    .load(this._src)
                    .then(function (a) {
                      return b._process(a, b.opts);
                    })
                    .then(
                      function (a) {
                        return (b._palette = a), c.remove(), a;
                      },
                      function (a) {
                        throw (c.remove(), a);
                      }
      ...
      function (a) {
        a.exports = function (a, b) {
          for (
            var c, d = -1, e = null == a ? 0 : a.length, f = 0, g = [];
            ++d < e;
      ...
      function (b, d, e) {
        ...
        b.exports = function (b, l) {
          var e = i(b),
            q = !e && k(b),
            r = !e && !q && n(b),
            h = !e && !q && !r && a(b),
            p = e || q || r || h,
            d = p ? j(b.length, String) : [],
            f = d.length;
          for (var m in b)
            (!l && !c.call(b, m)) ||
              (p &&
      ...
      function (a, b, c) {
        var d = c(108),
          f = c(2);
        a.exports = function b(c, e, g, h, i) {
          return (
            c === e ||
            (null != c && null != e && (f(c) || f(e))
              ? d(c, e, g, h, b, i)
              : c != c && e != e)
          );
        };
      ...
      function (a, b, c) {
        var j = c(109),
          f = c(112),
          d = c(113);
        a.exports = function (b, i, k, n, o, a) {
          var c = 1 & k,
            e = b.length,
            l = i.length;
          if (e != l && !(c && l > e)) return !1;
          var h = a.get(b);
          if (h && a.get(i)) return h == i;
          var p = -1,
            q = !0,
            r = 2 & k ? new j() : void 0;
          for (a.set(b, i), a.set(i, b); ++p < e; ) {
            var m = b[p],
              g = i[p];
            if (n) var s = c ? n(g, m, p, i, b, a) : n(m, g, p, b, i, a);
            if (void 0 !== s) {
              if (s) continue;
              q = !1;
              break;
            ...
            } else if (m !== g && !o(m, g, k, n, a)) {
              q = !1;
              break;
            }
          }
          return a.delete(b), a.delete(i), q;
        };
      },
      function (a, b, c) {
        var d = c(0).Uint8Array;
        a.exports = d;
      },
      function (a, b, c) {
        var d = c(49),
      ...
      function (a, b, c) {
        var d = c(55),
          f = c(17);
        a.exports = function (a, b) {
          for (var c = 0, g = (b = d(b, a)).length; null != a && c < g; )
            a = a[f(b[c++])];
          return c && c == g ? a : void 0;
        };
      },
      function (a, b, c) {
        var d = c(1),
      ...
      function (a, b, c) {
        ...
        a.exports = function (a, b, c) {
          var e = a[b];
          (g.call(a, b) && f(e, c) && (void 0 !== c || b in a)) || d(a, b, c);
        };
      },
      function (a, b, c) {
        var d = c(58);
      ...
      function (a, b, c) {
        var d = c(42)(Object.getPrototypeOf, Object);
        a.exports = d;
      },
      function (b, d, e) {
        var f = e(168),
          ...
          c = f(function (b, c) {
            ...
            var e = -1,
              o = c.length,
              q = 2 < o ? c[2] : void 0;
            for (q && i(c[0], c[1], q) && (o = 1); ++e < o; )
              for (var l = c[e], s = j(l), h = -1, u = s.length; ++h < u; ) {
                var d = s[h],
                  f = b[d];
                (void 0 === f || (g(f, k[d]) && !a.call(b, d))) &&
                  (b[d] = l[d]);
              }
            return b;
          });
        ...
        (function (e) {
          ...
          function d(b) {
            var d = b.clientWidth,
              e = b.clientHeight;
            if (!d && !e) return u;
            var h = A(b).getComputedStyle(b),
              j = (function (a) {
                for (
                  var b = {}, c = 0, d = ["top", "right", "bottom", "left"];
                  c < d.length;
                  c++
                ) {
                  var e = d[c],
              ...
              n = q(h.height);
            if (
              ("border-box" === h.boxSizing &&
                (Ta(m + i) !== d && (m -= p(h, "left", "right") + i),
                Ta(n + k) !== e && (n -= p(h, "top", "bottom") + k)),
              !(function (a) {
                return a === A(a).document.documentElement;
              })(b))
            ) {
              var o = Ta(m + i) - d,
                l = Ta(n + k) - e;
              1 !== Xa(o) && (m -= o), 1 !== Xa(l) && (n -= l);
            }
            return g(j.left, j.top, m, n);
          }
          function f(a) {
            return r
              ? c(a)
          ...
          var v = (function () {
                ...
                ? (function () {
                    ...
                    return (
                      ...
                      (b.prototype.forEach = function (a, b) {
                        void 0 === b && (b = null);
                        for (
                          var c, d = 0, f = this.__entries__;
                          d < f.length;
                          d++
                        )
                          (c = f[d]), a.call(b, c[1], c[0]);
                      }),
                      b
                    );
                  })()
            ...
            c =
              "undefined" == typeof SVGGraphicsElement
                ? function (a) {
                    return (
                      a instanceof A(a).SVGElement &&
                      "function" == typeof a.getBBox
                    );
                  }
                : function (a) {
                    return a instanceof A(a).SVGGraphicsElement;
                  },
            h = (function () {
              function a(a) {
            ...
            l = function (b, d) {
              var e,
                ...
                m =
                  ...
                  l);
              z(this, { target: b, contentRect: m });
            },
            m = (function () {
              function a(a, b, c) {
                if (
                  ((this.activeObservations_ = []),
                  (this.observations_ = new v()),
                  "function" != typeof a)
                )
                  throw new TypeError(
                  ...
                  if (this.hasActive()) {
                    var a = this.callbackCtx_,
                      b = this.activeObservations_.map(function (a) {
                        return new l(a.target, a.broadcastRect());
                      });
            ...
            b = "undefined" == typeof WeakMap ? new v() : new WeakMap(),
            w = function c(d) {
          ...
          ["observe", "unobserve", "disconnect"].forEach(function (a) {
            w.prototype[a] = function () {
              var c;
              return (c = b.get(this))[a].apply(c, arguments);
            };
          });
          var t = void 0 === n.ResizeObserver ? w : n.ResizeObserver;
          j.a = t;
        }.call(this, b(19)));
      },
      function (a, b, c) {
        var d =
          ...
          e = d(c(36)),
          f = d(c(178));
        (e.default.DefaultOpts.ImageClass = f.default), (a.exports = e.default);
      },
      function (a, b, c) {
        var d = c(37),
          f = c(65),
      ...
      function (a) {
        a.exports = function (b) {
          return function (d, e, f) {
            for (
              var g, h = -1, j = Object(d), k = f(d), l = k.length;
              l-- && ((g = k[b ? l : ++h]), !1 !== e(j[g], g, j));
      ...
      function (a, b, c) {
        ...
        (g["[object Float32Array]"] = g["[object Float64Array]"] = g[
          ...
          (g["[object Arguments]"] = g["[object Array]"] = g[
            "[object ArrayBuffer]"
          ] = g["[object Boolean]"] = g["[object DataView]"] = g[
            "[object Date]"
          ] = g["[object Error]"] = g["[object Function]"] = g[
            "[object Map]"
          ] = g["[object Number]"] = g["[object Object]"] = g[
            "[object RegExp]"
      ...
      function (a, b, c) {
        ...
        a.exports = function (b, c) {
          return function (e, f) {
            ...
            if (!d(e)) return b(e, f);
            for (
              var g = e.length, h = c ? g : -1, i = Object(e);
              (c ? h-- : ++h < g) && !1 !== f(i[h], h, i);
      ...
      function (a, b, c) {
        ...
        a.exports = function (b, i, e, k) {
          ...
          for (b = Object(b); m--; ) {
            var c = e[m];
            if (a && c[2] ? c[1] !== b[c[0]] : !(c[0] in b)) return !1;
          }
          for (; ++m < n; ) {
            var o = (c = e[m])[0],
              q = b[o],
            ...
            if (!(a && c[2])) {
              var p = new g();
              if (k) var d = k(q, h, o, b, i, p);
              if (void 0 === d ? !j(h, q, 3, k, p) : !d) return !1;
            } else if (void 0 === q && !(o in b)) return !1;
          }
          return !0;
        };
      },
      ...
      function (a, b, c) {
        ...
        a.exports = function (a) {
          ...
          return (
            !(0 > c) &&
            (c == b.length - 1 ? b.pop() : f.call(b, c, 1), --this.size, !0)
          );
        };
      },
      function (a, b, c) {
      ...
      function (a, b, c) {
        ...
        a.exports = function (a, b) {
          var c = this.__data__,
            e = d(c, a);
          return 0 > e ? (++this.size, c.push([a, b])) : (c[e][1] = b), this;
        };
      },
      function (a, b, c) {
        var d = c(12);
      ...
      function (a, b, d) {
        ...
        a.exports = function (a) {
          return (
            g(a) &&
            !f(a) &&
            (e(a) ? h : /^\[object .+?Constructor\]$/).test(i(a))
          );
        };
      },
      function (a, b, c) {
      ...
      function (b, d, e) {
        var h = e(27),
          ...
          l = e(41),
          g = Object.prototype.hasOwnProperty;
        b.exports = function (p, s, e, r, d, f) {
          var t = a(p),
            u = a(s),
            v = t ? "[object Array]" : q(p),
            z = u ? "[object Array]" : q(s),
            A =
              (v = "[object Arguments]" == v ? "[object Object]" : v) ==
              "[object Object]",
            B =
              (z = "[object Arguments]" == z ? "[object Object]" : z) ==
              "[object Object]",
            w = v == z;
          if (w && c(p)) {
            if (!c(s)) return !1;
          ...
          if (w && !A)
            return (
              f || (f = new h()),
              t || l(p) ? n(p, s, e, r, d, f) : i(p, s, v, e, r, d, f)
            );
          if (!(1 & e)) {
            var x = A && g.call(p, "__wrapped__"),
              k = B && g.call(s, "__wrapped__");
            if (x || k) {
              var C = x ? p.value() : p,
                D = k ? s.value() : s;
              return f || (f = new h()), d(C, D, e, r, f);
            }
          }
          return !!w && (f || (f = new h()), o(p, s, e, r, d, f));
        };
      },
      function (a, b, c) {
        function d(a) {
          var b = -1,
            c = null == a ? 0 : a.length;
          for (this.__data__ = new f(); ++b < c; ) this.add(a[b]);
        }
        var f = c(29),
          e = c(110),
          g = c(111);
        (d.prototype.add = d.prototype.push = e),
          (d.prototype.has = g),
          (a.exports = d);
      },
      function (a) {
      ...
      function (b, d, e) {
        var f = e(7),
          ...
          o = e(115),
          a = e(116),
          c = f ? f.prototype : void 0,
          q = c ? c.valueOf : void 0;
        b.exports = function (b, c, s, r, u, l, h) {
          switch (s) {
            ...
            case "[object ArrayBuffer]":
              return b.byteLength == c.byteLength && l(new j(b), new j(c));
            case "[object Boolean]":
            case "[object Date]":
            case "[object Number]":
              return i(+b, +c);
            ...
            case "[object Set]":
              var v = 1 & r;
              if ((p || (p = a), b.size != c.size && !v)) return !1;
              var f = h.get(b);
              if (f) return f == c;
              (r |= 2), h.set(b, c);
              var m = k(p(b), p(c), r, u, l, h);
              return h.delete(b), m;
            case "[object Symbol]":
              if (q) return q.call(b) == q.call(c);
          }
          return !1;
        };
      },
      ...
      function (a, b, c) {
        ...
        a.exports = function (i, k, e, n, o, q) {
          var a = 1 & e,
            c = j(i),
            l = c.length;
          if (l != j(k).length && !a) return !1;
          for (var r, s = l; s--; )
            if (((r = c[s]), a ? !(r in k) : !d.call(k, r))) return !1;
          var t = q.get(i);
          if (t && q.get(k)) return t == k;
          var u = !0;
          q.set(i, k), q.set(k, i);
          for (var w = a; ++s < l; ) {
            var x = i[(r = c[s])],
              g = k[r];
            if (n) var v = a ? n(g, x, r, k, i, q) : n(x, g, r, i, k, q);
            if (void 0 === v ? !(x === g || o(x, g, e, n, q)) : !v) {
              u = !1;
              break;
            }
            w || (w = "constructor" == r);
          ...
          return q.delete(i), q.delete(k), u;
        };
      },
      function (a, b, c) {
        var d = c(4)(c(0), "DataView");
        a.exports = d;
      },
      function (a, b, c) {
        var d = c(4)(c(0), "Promise");
        a.exports = d;
      },
      function (a, b, c) {
        var d = c(4)(c(0), "Set");
      ...
      function (b, d, e) {
        ...
        b.exports = function (b, d) {
          return i(b) && j(d)
            ...
            : function (a) {
                var c = g(a, b);
                return void 0 === c && c === d ? h(a, b) : f(d, c, 3);
              };
        };
      },
      function (a, b, c) {
      ...
      function (a, b, c) {
        function d(a, b) {
          ...
          return (c.cache = new (d.Cache || f)()), c;
        }
        var f = c(29);
        (d.Cache = f), (a.exports = d);
      },
      function (a, b, c) {
        var d = c(129);
        a.exports = function (a) {
      ...
      function (b, d, e) {
        var f = e(7),
          ...
          a = j ? j.toString : void 0;
        b.exports = function b(c) {
          if ("string" == typeof c) return c;
          if (h(c)) return g(c, b) + "";
          if (i(c)) return a ? a.call(c) : "";
          var d = c + "";
          return "0" == d && 1 / c == -1 / 0 ? "-0" : d;
        };
      },
      function (a) {
        a.exports = function (a, b) {
      ...
      function (b, d, e) {
        ...
        b.exports = function (b, c, d) {
          for (
            var m, n = -1, o = (c = f(c, b)).length, q = !1;
            ++n < o && ((m = a(c[n])), !!(q = null != b && d(b, m)));
          ...
          e = (function () {
            function a(a, b) {
              void 0 === b && (b = {}),
                (this._src = a),
                (this._opts = b),
                (this._opts.filters = g(f.default.DefaultOpts.filters));
            }
            return (
              (a.prototype.maxColorCount = function (a) {
                return (this._opts.colorCount = a), this;
              }),
              (a.prototype.maxDimension = function (a) {
                return (this._opts.maxDimension = a), this;
              }),
              (a.prototype.addFilter = function (a) {
                return this._opts.filters.push(a), this;
              }),
              (a.prototype.removeFilter = function (a) {
                var b = this._opts.filters.indexOf(a);
                return 0 < b && this._opts.filters.splice(b), this;
              }),
              (a.prototype.clearFilters = function () {
                return (this._opts.filters = []), this;
              }),
              (a.prototype.quality = function (a) {
                return (this._opts.quality = a), this;
              }),
              (a.prototype.useImageClass = function (a) {
                return (this._opts.ImageClass = a), this;
              }),
              (a.prototype.useGenerator = function (a) {
                return (this._opts.generator = a), this;
              }),
              (a.prototype.useQuantizer = function (a) {
                return (this._opts.quantizer = a), this;
              }),
              (a.prototype.build = function () {
                return new f.default(this._src, this._opts);
              }),
              (a.prototype.getPalette = function (a) {
                return this.build().getPalette(a);
              }),
              (a.prototype.getSwatches = function (a) {
                return this.build().getPalette(a);
              }),
              a
            );
      ...
      function (j, q, e) {
        ...
        (k["[object Arguments]"] = k["[object Array]"] = k[
          ...
          "[object RegExp]"
        ] = k["[object Set]"] = k["[object String]"] = k["[object Symbol]"] = k[
          "[object Uint8Array]"
          ...
          (j.exports = function q(x, e, y, D, j, E) {
            var F,
              G = 1 & e,
              H = 2 & e;
            if ((y && (F = j ? y(x, D, j, E) : y(x)), void 0 !== F)) return F;
            if (!b(x)) return x;
            var J = s(x);
            if (!J) {
              var K = d(x),
                I =
                  "[object Function]" == K || "[object GeneratorFunction]" == K;
              if (t(x)) return a(x, G);
              if (
                "[object Object]" != K &&
                "[object Arguments]" != K &&
                ...
                return H ? r(x, o(F, x)) : l(x, i(F, x));
            } else if (((F = f(x)), !G)) return c(x, F);
            E || (E = new B());
            var M = E.get(x);
            if (M) return M;
            E.set(x, F),
              v(x)
                ...
                : u(x) &&
                  x.forEach(function (a, b) {
                    F.set(b, q(a, e, y, b, x, E));
                  });
            var N = 4 & e ? (H ? p : h) : H ? keysIn : w,
              L = J ? void 0 : N(x);
            return (
              n(L || x, function (a, b) {
                L && (a = x[(b = a)]), A(F, b, q(a, e, y, b, x, E));
              }),
              F
            );
          });
      ...
      function (a, b, c) {
        ...
        a.exports = function (b) {
          ...
          var c = f(b),
            e = [];
          for (var i in b)
            ("constructor" != i || (!c && h.call(b, i))) && e.push(i);
          return e;
        };
      },
      function (a) {
      ...
      function (a) {
        ...
        a.exports = function (a) {
          var c = a.length,
            d = new a.constructor(c);
          return (
            c &&
              "string" == typeof a[0] &&
              b.call(a, "index") &&
              ((d.index = a.index), (d.input = a.input)),
            d
          );
        };
      },
      function (b, c, d) {
        ...
        b.exports = function (a, b, d) {
          var e = a.constructor;
          return "[object ArrayBuffer]" === b
            ? f(a)
            : "[object Boolean]" === b || "[object Date]" === b
            ? new e(+a)
            : "[object DataView]" === b
            ? g(a, d)
            : "[object Float32Array]" === b ||
              "[object Float64Array]" === b ||
              "[object Int8Array]" === b ||
              "[object Int16Array]" === b ||
              "[object Int32Array]" === b ||
              "[object Uint8Array]" === b ||
              "[object Uint8ClampedArray]" === b ||
              "[object Uint16Array]" === b ||
              "[object Uint32Array]" === b
            ? j(a, d)
            : "[object Map]" === b
            ? new e()
            : "[object Number]" === b || "[object String]" === b
            ? new e(a)
            : "[object RegExp]" === b
            ? h(a)
            : "[object Set]" === b
      ...
      function (a) {
        a.exports = function (a) {
          var b = new a.constructor(a.source, /\w*$/.exec(a));
          return (b.lastIndex = a.lastIndex), b;
        };
      },
      function (a, b, c) {
        var d = c(7),
          e = d ? d.prototype : void 0,
          f = e ? e.valueOf : void 0;
        a.exports = function (a) {
          return f ? Object(f.call(a)) : {};
        };
      },
      function (a, b, c) {
        var d = c(35);
      ...
      function (a, b, c) {
        var d = c(157),
          ...
          f = c(26);
        a.exports = function (a) {
          return "function" != typeof a.constructor || f(a) ? {} : d(e(a));
        };
      },
      function (a, b, c) {
        var d = c(3),
      ...
      function (a, b, c) {
        var d = c(16),
          e = c(2);
        a.exports = function (a) {
          return e(a) && "[object Set]" == d(a);
        };
      },
      function (a, b, c) {
        Object.defineProperty(b, "__esModule", { value: !0 });
        var d = c(163);
        (b.MMCQ = d.default), (b.WebWorker = null);
      },
      function (b, c, d) {
        function f(a, b) {
          for (
            var c, d = a.size();
            a.size() < b && ((c = a.pop()), !!(c && 0 < c.count()));

          ) {
            var e = c.split(),
              f = e[0],
              g = e[1];
            if ((a.push(f), g && 0 < g.count() && a.push(g), a.size() === d))
              break;
            d = a.size();
          }
        }
        ...
        c.default = function (a, b) {
          if (0 === a.length || 2 > b.colorCount || 256 < b.colorCount)
            throw new Error("Wrong MMCQ parameters");
          var d = h.default.build(a),
            e = d.hist,
            j =
              (Object.keys(e).length,
              new i.default(function (a, b) {
                return a.count() - b.count();
              }));
          j.push(d), f(j, 0.75 * b.colorCount);
          var c = new i.default(function (a, b) {
            return a.count() * a.volume() - b.count() * b.volume();
          });
          return (
            (c.contents = j.contents),
            f(c, b.colorCount - c.size()),
            (function (a) {
              for (var b = []; a.size(); ) {
                var c = a.pop(),
                  d = c.avg();
                d[0], d[1], d[2], b.push(new g.Swatch(d, c.count()));
              }
              return b;
            })(c)
          );
        ...
        var j = c(9),
          d = (function () {
            function b(a, b, c, d, e, f, g) {
              (this._volume = -1),
                (this._count = -1),
                (this.dimension = { r1: a, r2: b, g1: c, g2: d, b1: e, b2: f }),
                (this.hist = g);
            }
            return (
              (b.build = function (k) {
                var e,
                  ...
                  A = 1 << (3 * j.SIGBITS),
                  d = new Uint32Array(A);
                (e = q = t = 0), (n = r = w = Number.MAX_VALUE);
                for (var f, B = k.length / 4, m = 0; m < B; )
                  (f = 4 * m),
                    (m++,
                    (x = k[f + 0]),
                    (y = k[f + 1]),
              ...
              (b.prototype.volume = function () {
                if (0 > this._volume) {
                  var a = this.dimension,
                    ...
                    f = a.b1,
                    g = a.b2;
                  this._volume = (c - b + 1) * (e - d + 1) * (g - f + 1);
                }
                return this._volume;
              }),
              ...
              (b.prototype.clone = function () {
                var a = this.hist,
                  c = this.dimension;
                return new b(c.r1, c.r2, c.g1, c.g2, c.b1, c.b2, a);
              }),
              (b.prototype.avg = function () {
                if (!this._avg) {
                  var b,
                    k,
                    n,
              ...
              (b.prototype.split = function () {
                ...
                var z = null;
                if (d === t) {
                  (z = "r"), (m = new Uint32Array(q + 1));
                  for (var A = e; A <= q; A++) {
                    l = 0;
                    for (var B = i; B <= o; B++)
                      for (var C = r; C <= a; C++)
                        l += f[j.getColorIndex(A, B, C)];
                    (s += l), (m[A] = s);
                  }
                } else if (d === p)
                  for (
                    z = "g", m = new Uint32Array(o + 1), B = i;
                    B <= o;
                    B++
                  ) {
                    for (l = 0, A = e; A <= q; A++)
                      for (C = r; C <= a; C++) l += f[j.getColorIndex(A, B, C)];
                    (s += l), (m[B] = s);
                  }
                else
                  for (
                    z = "b", m = new Uint32Array(a + 1), C = r;
                    C <= a;
                    C++
                  ) {
                    for (l = 0, A = e; A <= q; A++)
                      for (B = i; B <= o; B++) l += f[j.getColorIndex(A, B, C)];
                    (s += l), (m[C] = s);
                  }
                for (
                  var D, E = -1, F = new Uint32Array(m.length), x = 0;
                  x < m.length;
                  x++
                )
                  (D = m[x]), 0 > E && D > s / 2 && (E = x), (F[x] = s - D);
                var G = this;
                return (function (b) {
                  var d = b + "1",
                    e = b + "2",
                  ...
                  for (
                    k <= a
                      ? ((g = Ua(g - 1, ~~(E + a / 2))), (g = Wa(0, g)))
                      : ((g = Wa(f, ~~(E - 1 - k / 2))),
                        (g = Ua(G.dimension[e], g)));
                    !m[g];

                  )
                    g++;
                  for (var c = F[g]; !c && m[g - 1]; ) c = F[--g];
                  return (h.dimension[e] = g), (j.dimension[d] = g + 1), [h, j];
                })(z);
              }),
              b
            );
      ...
      function (a, b) {
        ...
        var c = (function () {
          function a(a) {
            (this._comparator = a), (this.contents = []), (this._sorted = !1);
          }
          return (
            ...
            (a.prototype.push = function (a) {
              this.contents.push(a), (this._sorted = !1);
            }),
            (a.prototype.peek = function (a) {
              return (
                this._sort(),
                (a = "number" == typeof a ? a : this.contents.length - 1),
                this.contents[a]
              );
            }),
            ...
            (a.prototype.map = function (a) {
              return this._sort(), this.contents.map(a);
            }),
            a
          );
        })();
      ...
      function (b, c, d) {
        function f(b, d, g, j, k, i, n, o, a, c) {
          var l = null,
            p = 0;
          return (
                ...
                var f = (function (b, c, d, e, f, g, h) {
                  ...
                  return (function () {
                    for (var a = [], b = 0; b < arguments.length; b++)
                      a[b] = arguments[b];
                    for (var c = 0, d = 0, f = 0; f < a.length; f += 2) {
                      var g = a[f],
                        h = a[f + 1];
                      (c += g * h), (d += h);
                    }
        ...
        c.default = function (b, d) {
          d = a({}, d, g);
          var h = (function (a) {
              var b = 0;
              return (
                a.forEach(function (a) {
                  b = Wa(b, a.getPopulation());
                }),
                b
              );
            })(b),
            i = (function (a, b, c) {
              ...
              return (
                (d.Vibrant = f(
                  ...
                  c.minNormalLuma,
                  c.maxNormalLuma,
                  c.targetVibrantSaturation,
                  c.minVibrantSaturation,
                  1,
                  c
                )),
                (d.LightVibrant = f(
                ...
                (d.Muted = f(
                  ...
                  c.minNormalLuma,
                  c.maxNormalLuma,
                  c.targetMutesSaturation,
                  0,
                  c.maxMutesSaturation,
                  c
                )),
                (d.LightMuted = f(
                  d,
          ...
          return (
            (function (b, i, k) {
              if (
                ...
                if (null === b.DarkVibrant && null !== b.DarkMuted) {
                  var n = b.DarkMuted.getHsl(),
                    o = n[0],
                    q = n[1],
                    r = n[2];
                  (r = k.targetDarkLuma),
                    (b.DarkVibrant = new e.Swatch(j.hslToRgb(o, q, r), 0));
                }
                if (null === b.LightVibrant && null !== b.LightMuted) {
                  var t = b.LightMuted.getHsl();
                  (o = t[0]),
                    (q = t[1]),
                    (r = t[2]),
                    (r = k.targetDarkLuma),
              ...
              if (null === b.Vibrant && null !== b.DarkVibrant) {
                var l = b.DarkVibrant.getHsl();
                (o = l[0]),
                  (q = l[1]),
                  (r = l[2]),
                  (r = k.targetNormalLuma),
                  (b.Vibrant = new e.Swatch(j.hslToRgb(o, q, r), 0));
              } else if (null === b.Vibrant && null !== b.LightVibrant) {
                var u = b.LightVibrant.getHsl();
                (o = u[0]),
                  (q = u[1]),
                  (r = u[2]),
                  (r = k.targetNormalLuma),
              ...
              if (null === b.DarkVibrant && null !== b.Vibrant) {
                var h = b.Vibrant.getHsl();
                (o = h[0]),
                  (q = h[1]),
                  (r = h[2]),
                  (r = k.targetDarkLuma),
              ...
              if (null === b.LightVibrant && null !== b.Vibrant) {
                var p = b.Vibrant.getHsl();
                (o = p[0]),
                  (q = p[1]),
                  (r = p[2]),
                  (r = k.targetLightLuma),
                  (b.LightVibrant = new e.Swatch(j.hslToRgb(o, q, r), 0));
              }
              if (null === b.Muted && null !== b.Vibrant) {
                var d = b.Vibrant.getHsl();
                (o = d[0]),
                  (q = d[1]),
                  (r = d[2]),
                  (r = k.targetMutesSaturation),
                  (b.Muted = new e.Swatch(j.hslToRgb(o, q, r), 0));
              }
              if (null === b.DarkMuted && null !== b.DarkVibrant) {
                var f = b.DarkVibrant.getHsl();
                (o = f[0]),
                  (q = f[1]),
                  (r = f[2]),
                  (r = k.targetMutesSaturation),
                  (b.DarkMuted = new e.Swatch(j.hslToRgb(o, q, r), 0));
              }
              if (null === b.LightMuted && null !== b.LightVibrant) {
                var m = b.LightVibrant.getHsl();
                (o = m[0]),
                  (q = m[1]),
                  (r = m[2]),
                  (r = k.targetMutesSaturation),
                  (b.LightMuted = new e.Swatch(j.hslToRgb(o, q, r), 0));
              }
            })(i, 0, d),
            i
          );
      ...
      function (a, b, c) {
        var d = c(170),
          f = Wa;
        a.exports = function (b, g, h) {
          return (
            (g = f(void 0 === g ? b.length - 1 : g, 0)),
            function () {
              for (
                var e = arguments, i = -1, j = f(e.length - g, 0), a = Array(j);
                ++i < j;

              )
                a[i] = e[g + i];
              i = -1;
              for (var c = Array(g + 1); ++i < g; ) c[i] = e[i];
              return (c[g] = h(a)), d(b, this, c);
            }
          );
        };
      },
        ...
        a.exports = function (a) {
          ...
          return function () {
            var e = b(),
              f = 16 - (e - d);
            if (!((d = e), 0 < f)) c = 0;
            else if (800 <= ++c) return arguments[0];
      ...
      function (a, b, c) {
        var d = c(8),
          ...
          g = c(22),
          h = c(3);
        a.exports = function (b, c, e) {
          if (!h(e)) return !1;
          var i = typeof c;
          return (
            !("number" == i
              ? !(f(e) && g(c, e.length))
              : !("string" == i && c in e)) && d(e[c], b)
          );
        };
      },
      function (a, b, c) {
        ...
        var d = c(177);
        (b.Default = d.default),
          (b.combineFilters = function (a) {
            return Array.isArray(a) && 0 !== a.length
              ? function (b, c, d, e) {
                  if (0 === e) return !1;
                  for (var f = 0; f < a.length; f++)
                    if (!a[f](b, c, d, e)) return !1;
                  return !0;
                }
              : null;
          });
      ...
      function (a, b) {
        Object.defineProperty(b, "__esModule", { value: !0 }),
          (b.default = function (a, b, c, d) {
            return 125 <= d && !(250 < a && 250 < b && 250 < c);
          });
      },
      function (b, d, e) {
        var f,
        ...
        var i = e(179),
          ...
          a = (function (a) {
            ...
            return (
              g(b, a),
              (b.prototype._initCanvas = function () {
                var a = this.image,
                  b = (this._canvas = document.createElement("canvas")),
                  c = (this._context = b.getContext("2d"));
                (b.className = "vibrant-canvas"),
                  (b.style.display = "none"),
                  (this._width = b.width = a.width),
                  (this._height = b.height = a.height),
                  c.drawImage(a, 0, 0),
                ...
                return (
                  ...
                  new Promise(function (a, b) {
                    ...
                    c.complete
                      ...
                      : ((c.onload = d),
                        (c.onerror = function () {
                          return b(new Error("Fail to load image: " + p));
                        }));
                  })
                );
              }),
              ...
              (b.prototype.update = function (a) {
                this._context.putImageData(a, 0, 0);
              }),
              ...
              (b.prototype.resize = function (a, b, c) {
                var d = this._canvas,
                  e = this._context,
                  f = this.image;
                (this._width = d.width = a),
                  (this._height = d.height = b),
                  e.scale(c, c),
                  e.drawImage(f, 0, 0);
              }),
      ...
      function (a, b) {
        ...
        var c = (function () {
          function a() {}
          return (
            (a.prototype.scaleDown = function (a) {
              var b = this.getWidth(),
                c = this.getHeight(),
                d = 1;
              if (0 < a.maxDimension) {
                var e = Wa(b, c);
                e > a.maxDimension && (d = a.maxDimension / e);
              } else d = 1 / a.quality;
              1 > d && this.resize(b * d, c * d, d);
            }),
            (a.prototype.applyFilter = function (a) {
              var b = this.getImageData();
              if ("function" == typeof a)
                for (
                  var c = b.data, d = c.length / 4, e = void 0, f = 0;
                  f < d;
                  f++
                )
                  a(c[(e = 4 * f) + 0], c[e + 1], c[e + 2], c[e + 3]) ||
                    (c[e + 3] = 0);
      ...
      function (a, b, c) {
        ...
        function j(a, b, c) {
          if (a && G.isObject(a) && a instanceof f) return a;
          var d = new f();
        ...
        (b.parse = j),
          (b.resolve = function (a, b) {
            return j(a, !1, !0).resolve(b);
          }),
          (b.resolveObject = function (a, b) {
            return a ? j(a, !1, !0).resolveObject(b) : b;
          }),
          (b.format = function (a) {
            return (
              G.isString(a) && (a = j(a)),
        ...
        var i = ["{", "}", "|", "\\", "^", "`"].concat([
          ...
          m = c(183);
        (f.prototype.parse = function (c, f, i) {
          if (!G.isString(c))
            throw new TypeError(
          ...
          a[0] = a[0].replace(/\\/g, "/");
          var r = (c = a.join(o));
          if (((r = r.trim()), !i && 1 === c.split("#").length)) {
            var u = /^(\/\/?(?!\/)[^\?\s]*)(\?[^\s]*)?$/.exec(r);
            if (u)
              return (
                (this.path = r),
                ...
                u[2]
                  ...
                  : f && ((this.search = ""), (this.query = {})),
                this
              );
          }
          var b = /^([a-z0-9.+-]+:)/i.exec(r);
          if (b) {
            var v = (b = b[0]).toLowerCase();
            (this.protocol = v), (r = r.substr(b.length));
          }
          if (i || b || r.match(/^\/\/[^@\/]+@[^@\/]+/)) {
            var x = "//" === r.substr(0, 2);
            !x || (b && s[b]) || ((r = r.substr(2)), (this.slashes = !0));
          }
          if (!s[b] && (x || (b && !g[b]))) {
            for (var J, K, Q = -1, W = 0; W < h.length; W++)
              -1 !== (X = r.indexOf(h[W])) && (-1 === Q || X < Q) && (Q = X);
            for (
              -1 !==
                (K = -1 === Q ? r.lastIndexOf("@") : r.lastIndexOf("@", Q)) &&
                ((J = r.slice(0, K)),
                (r = r.slice(K + 1)),
              ...
              var X;
              -1 !== (X = r.indexOf(l[W])) && (-1 === Q || X < Q) && (Q = X);
            }
            -1 === Q && (Q = r.length),
              (this.host = r.slice(0, Q)),
              (r = r.slice(Q)),
              this.parseHost(),
            ...
            if (!Y)
              for (
                var P, Z = this.hostname.split(/\./), A = ((W = 0), Z.length);
                W < A;
                W++
              )
                if (((P = Z[W]), P && !P.match(n))) {
                  for (var _ = "", aa = 0, ba = P.length; aa < ba; aa++)
                    _ += 127 < P.charCodeAt(aa) ? "x" : P[aa];
                  if (!_.match(n)) {
                    var V = Z.slice(0, W),
                      N = Z.slice(W + 1),
                      L = P.match(/^([+a-z0-9A-Z_-]{0,63})(.*)$/);
                    L && (V.push(L[1]), N.unshift(L[2])),
                      N.length && (r = "/" + N.join(".") + r),
          ...
          if (!d[v])
            for (W = 0, A = k.length; W < A; W++) {
              ...
              if (-1 !== r.indexOf(R)) {
                ...
                F === R && (F = escape(R)), (r = r.split(R).join(F));
              }
            }
          var da = r.indexOf("#");
          -1 !== da && ((this.hash = r.substr(da)), (r = r.slice(0, da)));
          var B = r.indexOf("?");
          if (
            (-1 === B
              ? f && ((this.search = ""), (this.query = {}))
              : ((this.search = r.substr(B)),
                (this.query = r.substr(B + 1)),
                f && (this.query = m.parse(this.query)),
                (r = r.slice(0, B))),
            r && (this.pathname = r),
            g[v] && this.hostname && !this.pathname && (this.pathname = "/"),
          ...
          (f.prototype.format = function () {
            ...
            this.host
              ...
              this.query &&
                G.isObject(this.query) &&
                Object.keys(this.query).length &&
                (i = m.stringify(this.query));
            var j = this.search || (i && "?" + i) || "";
            return (
              c && ":" !== c.substr(-1) && (c += ":"),
              this.slashes || ((!c || g[c]) && !1 !== h)
                ? ((h = "//" + (h || "")),
                  d && "/" !== d.charAt(0) && (d = "/" + d))
                : h || (h = ""),
              f && "#" !== f.charAt(0) && (f = "#" + f),
          ...
          (f.prototype.resolve = function (a) {
            return this.resolveObject(j(a, !1, !0)).format();
          }),
          (f.prototype.resolveObject = function (i) {
            if (G.isString(i)) {
              var o = new f();
              o.parse(i, !1, !0), (i = o);
            }
            for (
              var e, q = new f(), r = Object.keys(this), n = 0;
              n < r.length;
              n++
            )
              (e = r[n]), (q[e] = this[e]);
            if (((q.hash = i.hash), "" === i.href))
              return (q.href = q.format()), q;
            if (i.slashes && !i.protocol) {
              for (var v, z = Object.keys(i), c = 0; c < z.length; c++)
                (v = z[c]), "protocol" !== v && (q[v] = i[v]);
              return (
                g[q.protocol] &&
                  q.hostname &&
                  !q.pathname &&
            ...
            if (i.protocol && i.protocol !== q.protocol) {
              if (!g[i.protocol]) {
                for (var B, D = Object.keys(i), h = 0; h < D.length; h++)
                  (B = D[h]), (q[B] = i[B]);
                return (q.href = q.format()), q;
              }
              if (((q.protocol = i.protocol), i.host || s[i.protocol]))
                q.pathname = i.pathname;
              else {
                for (
                  var E = (i.pathname || "").split("/");
                  E.length && !(i.host = E.shift());
              ...
              return (
                (q.slashes = q.slashes || i.slashes), (q.href = q.format()), q
              );
            }
            var H = q.pathname && "/" === q.pathname.charAt(0),
              y = i.host || (i.pathname && "/" === i.pathname.charAt(0)),
              b = y || H || (q.host && i.pathname),
              I = b,
              x = (q.pathname && q.pathname.split("/")) || [],
              J =
                ((E = (i.pathname && i.pathname.split("/")) || []),
                q.protocol && !g[q.protocol]);
            if (
              (J &&
                ((q.hostname = ""),
                (q.port = null),
                q.host && ("" === x[0] ? (x[0] = q.host) : x.unshift(q.host)),
                (q.host = ""),
                i.protocol &&
                  ((i.hostname = null),
                  (i.port = null),
                  i.host && ("" === E[0] ? (E[0] = i.host) : E.unshift(i.host)),
                  (i.host = null)),
                (b = b && ("" === E[0] || "" === x[0]))),
              y)
            )
              (q.host = i.host || "" === i.host ? i.host : q.host),
                (q.hostname =
                  i.hostname || "" === i.hostname ? i.hostname : q.hostname),
                (q.search = i.search),
                (q.query = i.query),
                (x = E);
            else if (E.length)
              x || (x = []),
                ...
                (q.search = i.search),
                (q.query = i.query);
            else if (!G.isNullOrUndefined(i.search))
              return (
                J &&
                  ((q.hostname = q.host = x.shift()),
                  (N =
                    !!(q.host && 0 < q.host.indexOf("@")) &&
                    q.host.split("@")) &&
                    ((q.auth = N.shift()), (q.host = q.hostname = N.shift()))),
                (q.search = i.search),
                (q.query = i.query),
                (G.isNull(q.pathname) && G.isNull(q.search)) ||
                  (q.path =
            ...
            var N,
              Q = "" === x[0] || (x[0] && "/" === x[0].charAt(0));
            return (
              J &&
                ((q.hostname = q.host = Q ? "" : x.length ? x.shift() : ""),
                (N =
                  !!(q.host && 0 < q.host.indexOf("@")) && q.host.split("@")) &&
                  ((q.auth = N.shift()), (q.host = q.hostname = N.shift()))),
              (b = b || (q.host && x.length)) && !Q && x.unshift(""),
              x.length
                ? (q.pathname = x.join("/"))
                : ((q.pathname = null), (q.path = null)),
              (G.isNull(q.pathname) && G.isNull(q.search)) ||
                (q.path =
                  (q.pathname ? q.pathname : "") + (q.search ? q.search : "")),
              (q.auth = i.auth || q.auth),
              (q.slashes = q.slashes || i.slashes),
              (q.href = q.format()),
              q
            );
          }),
          ...
          !(function () {
            ...
            function g(a, b) {
              ...
              return (
                ...
                d + i((a = a.replace(s, ".")).split("."), b).join(".")
              );
            }
            function m(a) {
              for (var b, c, d = [], f = 0, g = a.length; f < g; )
                55296 <= (b = a.charCodeAt(f++)) && 56319 >= b && f < g
                  ? 56320 == (64512 & (c = a.charCodeAt(f++)))
            ...
            function A(a, b, c) {
              var d = 0;
              for (a = c ? w(a / 700) : a >> 1, a += w(a / b); 455 < a; d += 36)
                a = w(a / 35);
              return w(d + (36 * a) / (a + 38));
            }
            function b(c) {
              var d,
                j,
                ...
                G = 128,
                H = 72;
              for (0 > (j = c.lastIndexOf("-")) && (j = 0), k = 0; k < j; ++k)
                128 <= c.charCodeAt(k) && q("not-basic"),
                  F.push(c.charCodeAt(k));
              for (m = 0 < j ? j + 1 : 0; m < f; ) {
                for (
                  t = g, x = 1, y = 36;
                  m >= f && q("invalid-input"),
                    (36 <=
                      ...
                      q("overflow"),
                    (g += B * x),
                    !(B < (C = y <= H ? 1 : y >= H + 26 ? 26 : y - H));
                  y += 36
                )
                  x > w(2147483647 / (D = 36 - C)) && q("overflow"), (x *= D);
                (H = A(g - t, (d = F.length + 1), 0 == t)),
                  w(g / d) > 2147483647 - G && q("overflow"),
                  (G += w(g / d)),
                  (g %= d),
                  F.splice(g++, 0, G);
              }
            ...
            function o(b) {
              var c,
                ...
                M = [];
              for (
                I = (b = m(b)).length, c = 128, f = 0, B = 72, C = 0;
                C < I;
                ++C
              )
                128 > (H = b[C]) && M.push(d(H));
              for (j = z = M.length, z && M.push("-"); j < I; ) {
                for (D = 2147483647, C = 0; C < I; ++C)
                  (H = b[C]) >= c && H < D && (D = H);
                for (
                  D - c > w((2147483647 - f) / (J = j + 1)) && q("overflow"),
                    f += (D - c) * J,
                    c = D,
                    C = 0;
                  C < I;
                  ...
                  if (
                    ((H = b[C]) < c && ++f > 2147483647 && q("overflow"),
                    H == c)
                  ) {
                    for (
                      E = f, F = 36;
                      !(E < (G = F <= B ? 1 : F >= B + 26 ? 26 : F - B));
                      F += 36
                    )
                      (L = E - G),
                        (K = 36 - G),
                        M.push(d(t(G + (L % K), 0))),
                        (E = w(L / K));
                    M.push(d(t(E, 0))), (B = A(f, J, j == z)), (f = 0), ++j;
                  }
                ++f, ++c;
              }
              return M.join("");
            }
            c && c.nodeType, j && j.nodeType;
            var k = "object" == typeof l && l;
            k.global !== k && k.window !== k && k.self;
            var r,
              s = /[\x2E\u3002\uFF0E\uFF61]/g,
              h = {
            ...
            (r = {
              version: "1.4.1",
              ucs2: { decode: m, encode: z },
              decode: b,
              encode: o,
              toASCII: function (a) {
                return g(a, function (a) {
                  return /[^\x20-\x7E]/.test(a) ? "xn--" + o(a) : a;
                });
              },
              toUnicode: function (a) {
                return g(a, function (a) {
                  return /^xn--/.test(a) ? b(a.slice(4).toLowerCase()) : a;
                });
              },
            }),
              void 0 ===
                (n = function () {
                  return r;
                }.call(c, e, c, j)) || (j.exports = n);
          })();
        }.call(this, e(10)(a), e(19)));
      },
      function (a) {
        a.exports = {
          isString: function (a) {
      ...
      function (a, b, c) {
        (b.decode = b.parse = c(184)), (b.encode = b.stringify = c(185));
      },
      function (a) {
        function b(a, b) {
          return Object.prototype.hasOwnProperty.call(a, b);
        }
        a.exports = function (a, i, j, k) {
          (i = i || "&"), (j = j || "=");
          var n = {};
          if ("string" != typeof a || 0 === a.length) return n;
          a = a.split(i);
          var o = 1e3;
          k && "number" == typeof k.maxKeys && (o = k.maxKeys);
          var q = a.length;
          0 < o && q > o && (q = o);
          for (var s = 0; s < q; ++s) {
            var v,
              ...
              m = z.indexOf(j);
            0 <= m
              ? ((v = z.substr(0, m)), (w = z.substr(m + 1)))
              : ((v = z), (w = "")),
              (x = decodeURIComponent(v)),
              (y = decodeURIComponent(w)),
              b(n, x)
                ? c(n[x])
                  ? n[x].push(y)
                  : (n[x] = [n[x], y])
      ...
      function (a) {
        ...
        a.exports = function (g, h, i, j) {
          return (
            ...
            "object" == typeof g
              ? b(f(g), function (e) {
                  var f = encodeURIComponent(c(e)) + i;
                  return d(g[e])
                    ? b(g[e], function (a) {
                        return f + encodeURIComponent(c(a));
                      }).join(h)
                    : f + encodeURIComponent(c(g[e]));
                }).join(h)
              : j
              ? encodeURIComponent(c(j)) + i + encodeURIComponent(c(g))
              : ""
          );
        };
        var d =
      ...
      function (Za, t, $a) {
        function _a(b, d) {
          for (
            var {
              ...
              g = document.createTreeWalker(f, 133, null, !1),
              h = mb(e),
              i = e[h],
              j = -1,
              k = 0,
            ...
            var n = g.currentNode;
            for (
              n.previousSibling === l && (l = null),
                d.has(n) && (m.push(n), null === l && (l = n)),
                null !== l && k++;
              void 0 !== i && i.index === j;

            )
              (i.index = null === l ? i.index - k : -1),
                (h = mb(e, h)),
                (i = e[h]);
          }
        ...
        function ab(a) {
          ...
          var d = a.strings.join(db);
          return (
            (c = b.keyString.get(d)),
            void 0 === c &&
              ((c = new gb(a, a.getTemplateElement())), b.keyString.set(d, c)),
        ...
        var bb =
          ...
          db = "{{lit-".concat((Math.random() + "").slice(2), "}}"),
          eb = "<!--".concat(db, "-->"),
          fb = new RegExp("".concat(db, "|").concat(eb));
        class gb {
          constructor(a, b) {
            ...
            for (
              var e = [],
                g = [],
                h = document.createTreeWalker(b.content, 133, null, !1),
                i = 0,
                j = -1,
                k = 0,
                {
              ...
              var v = h.nextNode();
              if (!(null !== v)) h.currentNode = g.pop();
              else if ((j++, 1 === v.nodeType)) {
                if (v.hasAttributes()) {
                  for (
                    var f = v.attributes, { length: m } = f, n = 0, o = 0;
                    o < m;
                    o++
                  )
                    hb(f[o].name, "$lit$") && n++;
                ...
                "TEMPLATE" === v.tagName &&
                  (g.push(v), (h.currentNode = v.content));
                ...
                if (0 <= B.indexOf(db)) {
                  for (
                    ...
                    p.insertBefore(C, v),
                      this.parts.push({ type: "node", index: ++j });
                  }
                  "" === q[r]
                    ? (p.insertBefore(jb(), v), e.push(v))
                    : (v.data = q[r]),
                    (k += r);
                }
                ...
                if (v.data === db) {
                  var F = v.parentNode;
                  (null !== v.previousSibling && j !== i) ||
                    (j++, F.insertBefore(jb(), v)),
                    (i = j),
                    this.parts.push({ type: "node", index: j }),
                    null === v.nextSibling ? (v.data = "") : (e.push(v), j--),
                    k++;
                } else
                  for (var G = -1; -1 !== (G = v.data.indexOf(db, G + 1)); )
                    this.parts.push({ type: "node", index: -1 }), k++;
            }
            for (var H of e) H.parentNode.removeChild(H);
          }
        }
        var hb = (a, b) => {
          ...
          ib = (a) => -1 !== a.index,
          jb = () => document.createComment(""),
          kb = /([ \x09\x0a\x0c\x0d])([^\0-\x1F\x7F-\x9F "'>=/]+)([ \x09\x0a\x0c\x0d]*=[ \x09\x0a\x0c\x0d]*(?:[^ \x09\x0a\x0c\x0d"'`<>=]*|"[^"]*|'[^']*))$/,
          lb = (a) => {
            for (
          ...
          pb = (a) => "function" == typeof a && nb.has(a),
          qb = {},
          rb = {};
        class sb {
          constructor(a, b, c) {
          ...
          _clone() {
            for (
              var b,
                ...
                g = document.createTreeWalker(d, 133, null, !1),
                h = 0,
                i = 0,
                j = g.nextNode();
              h < e.length;
              ...
              if (((b = e[h]), ib(b))) {
                for (; i < b.index; )
                  i++,
                    "TEMPLATE" === j.nodeName &&
                      (f.push(j), (g.currentNode = j.content)),
                    null === (j = g.nextNode()) &&
                      ((g.currentNode = f.pop()), (j = g.nextNode()));
                if ("node" === b.type) {
                  var k = this.processor.handleTextExpression(this.options);
                  k.insertAfterNode(j.previousSibling), this.__parts.push(k);
                } else
                  this.__parts.push(
                ...
                h++;
              } else this.__parts.push(void 0), h++;
            return bb && (document.adoptNode(d), customElements.upgrade(d)), d;
          }
        }
        var tb = " ".concat(db, " ");
        class ub {
          ...
          getHTML() {
            for (
              ...
              var f = this.strings[d],
                g = f.lastIndexOf("<!--");
              c = (-1 < g || c) && -1 === f.indexOf("-->", g + 1);
              var h = kb.exec(f);
              b +=
                null === h
                  ? f + (c ? tb : eb)
                  : f.substr(0, h.index) + h[1] + h[2] + "$lit$" + h[3] + db;
            }
        ...
        var vb = (a) =>
          ...
          wb = (a) => Array.isArray(a) || (a && a[Symbol.iterator]);
        class xb {
          constructor(a, b, c) {
            (this.dirty = !0),
              (this.element = a),
          ...
          _getValue() {
            for (
              ...
              if (void 0 !== e) {
                var f = e.value;
                if (vb(f) || !wb(f)) c += "string" == typeof f ? f : f + "";
        ...
        class yb {
          ...
          setValue(a) {
            a === qb ||
              (vb(a) && a === this.value) ||
              ((this.value = a), pb(a) || (this.committer.dirty = !0));
          }
          commit() {
            for (; pb(this.value); ) {
              var a = this.value;
              (this.value = qb), a(this);
            }
            this.value !== qb && this.committer.commit();
          }
        }
        class zb {
          constructor(a) {
          ...
          appendInto(a) {
            (this.startNode = a.appendChild(jb())),
              (this.endNode = a.appendChild(jb()));
          }
          insertAfterNode(a) {
            (this.startNode = a), (this.endNode = a.nextSibling);
          }
          appendIntoPart(a) {
            a.__insert((this.startNode = jb())),
              a.__insert((this.endNode = jb()));
          }
          insertAfterPart(a) {
            a.__insert((this.startNode = jb())),
          ...
          commit() {
            if (null !== this.startNode.parentNode) {
              for (; pb(this.__pendingValue); ) {
                var b = this.__pendingValue;
                (this.__pendingValue = qb), b(this);
              }
          ...
          __commitNode(a) {
            this.value !== a &&
              (this.clear(), this.__insert(a), (this.value = a));
          }
          __commitText(a) {
            var b = this.startNode.nextSibling,
              c = "string" == typeof (a = null == a ? "" : a) ? a : a + "";
          ...
          __commitTemplateResult(a) {
            ...
            if (this.value instanceof sb && this.value.template === b)
              this.value.update(a.values);
            else {
              var c = new sb(b, a.processor, this.options),
                d = c._clone();
          ...
          __commitIterable(a) {
            ...
            for (var e of a)
              (b = c[d]),
                void 0 === b &&
                  ((b = new zb(this.options)),
                  c.push(b),
                  0 === d
                    ? b.appendIntoPart(this)
                    : b.insertAfterPart(c[d - 1])),
                b.setValue(e),
                b.commit(),
                d++;
          ...
          clear() {
            var a =
              0 < arguments.length && arguments[0] !== void 0
                ? arguments[0]
                : this.startNode;
            cb(this.startNode.parentNode, a.nextSibling, this.endNode);
          }
        }
        class Ab {
          constructor(a, b, c) {
        ...
        var Fb = (a) =>
          ...
          Ib = new (class {
            handleAttributeExpressions(a, b, c, d) {
              var e = b[0];
              return "." === e
                ? new Bb(a, b.slice(1), c).parts
                : "@" === e
                ? [new Eb(a, b.slice(1), d.eventContext)]
                : "?" === e
                ? [new Ab(a, b.slice(1), c)]
                : new xb(a, b, c).parts;
            }
        ...
        var Jb = function (a) {
            for (
              ...
              c[d - 1] = arguments[d];
            return new ub(a, c, "html", Ib);
          },
          Kb = (a, b) => "".concat(a, "--").concat(b),
          Lb = !0;
        ...
        var Mb = (a) => (b) => {
            ...
            var f = b.strings.join(db);
            if (((e = d.keyString.get(f)), void 0 === e)) {
              var g = b.getTemplateElement();
              Lb && window.ShadyCSS.prepareTemplateDom(g, a),
                (e = new gb(b, g)),
                d.keyString.set(f, e);
            }
          ...
          Pb = (b, d, e) => {
            Ob.add(b);
            var f = e ? e.element : document.createElement("template"),
              g = d.querySelectorAll("style"),
              { length: h } = g;
            if (0 === h)
              return void window.ShadyCSS.prepareTemplateStyles(f, b);
            for (var i, j = document.createElement("style"), k = 0; k < h; k++)
              (i = g[k]),
                i.parentNode.removeChild(i),
                (j.textContent += i.textContent);
            ((a) => {
              Nb.forEach((b) => {
                var c = Gb.get(Kb(b, a));
                void 0 !== c &&
            ...
            e
              ? (function (b, d) {
                  ...
                  if (null == e) return void g.appendChild(d);
                  for (
                    var h = document.createTreeWalker(g, 133, null, !1),
                      i = mb(f),
                      j = 0,
                      k = -1;
                    h.nextNode();
                    ...
                    for (
                      k++,
                        h.currentNode === e &&
                          ((j = lb(d)), e.parentNode.insertBefore(d, e));
                      -1 !== i && f[i].index === k;

                    ) {
                      if (0 < j) {
                        for (; -1 !== i; ) (f[i].index += j), (i = mb(f, i));
                        return;
                      }
                      i = mb(f, i);
                    }
              ...
              window.ShadyCSS.prepareTemplateStyles(f, b);
            var a = l.querySelector("style");
            if (window.ShadyCSS.nativeShadow && null !== a)
              d.insertBefore(a.cloneNode(!0), d.firstChild);
            else if (e) {
              l.insertBefore(j, l.firstChild);
              var c = new Set();
              c.add(j), _a(e, c);
        ...
        class Tb extends HTMLElement {
          ...
          static get observedAttributes() {
            ...
            return (
              this._classProperties.forEach((b, c) => {
                ...
                void 0 !== d &&
                  (this._attributeToPropertyMap.set(d, c), a.push(d));
              }),
              a
            );
          }
          static _ensureClassProperties() {
            if (
              ...
              void 0 !== a &&
                a.forEach((a, b) => this._classProperties.set(b, a));
            }
          }
          ...
          static getPropertyOptions(a) {
            return (
              (this._classProperties && this._classProperties.get(a)) || Sb
            );
          }
          static finalize() {
            var a = Object.getPrototypeOf(this);
            if (
              (a.hasOwnProperty("finalized") || a.finalize(),
              (this.finalized = !0),
              this._ensureClassProperties(),
          ...
          static _propertyValueToAttribute(a, b) {
            if (void 0 !== b.reflect) {
              var c = b.type,
                d = b.converter;
              return ((d && d.toAttribute) || Qb.toAttribute)(a, c);
            }
          }
          initialize() {
          ...
          _enqueueUpdate() {
            var a = this;
            return Ya(function* () {
              a._updateState = 4 | a._updateState;
              try {
        ...
        (Zb.finalized = !0),
          (Zb.render = (b, d, e) => {
            if (!e || "object" != typeof e || !e.scopeName)
              throw new Error("The `scopeName` option is required.");
            var f = e.scopeName,
              g = Hb.has(d),
              h = Lb && 11 === d.nodeType && !!d.host,
              i = h && !Ob.has(f),
              a = i ? document.createDocumentFragment() : d;
            if (
              (((a, b, c) => {
                var d = Hb.get(b);
                void 0 === d &&
                  ...
                  Hb.set(
                    b,
                    (d = new zb(Object.assign({ templateFactory: ab }, c)))
                  ),
                  d.appendInto(b)),
                  d.setValue(a),
                  d.commit();
              })(b, a, Object.assign({ templateFactory: Mb(f) }, e)),
              i)
            ) {
              var c = Hb.get(a);
              Hb.delete(a);
              var j = c.value instanceof sb ? c.value.template : void 0;
              Pb(f, a, j), cb(d, d.firstChild), d.appendChild(a), Hb.set(d, c);
            }
            !g && h && window.ShadyCSS.styleElement(d.host);
          });
        class $b {
          constructor(a) {
        ...
        var _b = new WeakMap(),
          ac = ob((a) => (b) => {
            ...
            void 0 === f &&
              ...
              _b.set(b, (f = new Set())));
            var g = d.classList || new $b(d);
            for (var e in (f.forEach((b) => {
              b in a || (g.remove(b), f.delete(b));
            }),
            a)) {
              var h = a[e];
              h != f.has(e) &&
                (h ? (g.add(e), f.add(e)) : (g.remove(e), f.delete(e)));
            }
            "function" == typeof g.commit && g.commit();
          }),
          bc = new WeakMap(),
          cc = ob((a) => (b) => {
            if (
            ...
            var { committer: c } = b,
              { style: d } = c.element,
              f = bc.get(b);
            for (var e in (void 0 === f &&
              ((d.cssText = c.strings.join(" ")), bc.set(b, (f = new Set()))),
            f.forEach((b) => {
              b in a ||
                (f.delete(b),
            ...
            a))
              f.add(e),
                -1 === e.indexOf("-") ? (d[e] = a[e]) : d.setProperty(e, a[e]);
          }),
          dc = $a(62),
          ec = {
            shuffle: !0,
          ...
          fc = "mdi:chevron-down",
          gc = { true: "mdi:volume-off", false: "mdi:volume-high" },
          hc = "mdi:skip-next",
          ic = { true: "mdi:pause", false: "mdi:play" },
          jc = { true: "mdi:stop", false: "mdi:play" },
          kc = [
            "entity",
            "groupMgmtEntity",
            "_overflow",
          ...
          pc = (a) => {
            ...
            var b = Va(
              ...
              {},
              {
                hide: Va(Va({}, ec), a.hide),
                speaker_group: Va(
                  Va({ show_group_count: !0, platform: "sonos" }, a.sonos),
                  a.speaker_group
                ),
                shortcuts: Va({ label: "Przekieruj media na" }, a.shortcuts),
              }
            );
            return (
          ...
          qc = (a) => {
            var b = "";
            return (
              [].slice.call(new Uint8Array(a)).forEach((a) => (b += D(a))),
              window.btoa(b)
            );
          };
        class rc {
          constructor(a, b, c) {
            (this.hass = a || {}),
              (this.config = b || {}),
              (this.entity = c || {}),
              (this.entityId = (c && c.entity_id) || this.config.entity),
              (this.state = c.state),
          ...
          get mediaInfo() {
            return mc
              .map((a) => Va({ text: this.attr[a.attr], prefix: "" }, a))
              .filter((a) => a.text);
          }
          get hasProgress() {
            return (
              ...
              !this.idle &&
              lc.every((a) => a in this.attr)
            );
          }
          get supportsPrev() {
            return (
              (16 | this.attr.supported_features) ===
              this.attr.supported_features
            );
          }
          get supportsNext() {
            return (
              (32 | this.attr.supported_features) ===
              this.attr.supported_features
            );
          }
          get progress() {
          ...
          fetchArtwork() {
            var a = this;
            return Ya(function* () {
              var b = a.attr.entity_picture_local
                ? a.hass.hassUrl(a.picture)
                : a.picture;
              try {
                var c = yield fetch(new Request(b)),
                  d = yield c.arrayBuffer(),
                  e = qc(d);
                return "url(data:"
                  .concat(
                    c.headers.get("Content-Type") || "image/jpeg",
                    ";base64,"
                  )
                  .concat(e, ")");
              } catch (a) {
          ...
          setMedia(a, b) {
            this.callService(a, "play_media", Va({}, b));
          }
          playPause(a) {
          ...
          volumeUp(a) {
            this.supportsVolumeSet && 0 < this.config.volume_step
              ? this.callService(a, "volume_set", {
                  ...
                  volume_level: Ua(this.vol + this.config.volume_step / 100, 1),
                })
          ...
          volumeDown(a) {
            this.supportsVolumeSet && 0 < this.config.volume_step
              ? this.callService(a, "volume_set", {
                  entity_id: this.entityId,
                  volume_level: Wa(this.vol - this.config.volume_step / 100, 0),
                })
          ...
          handleGroupChange(a, b, c) {
            var { platform: d } = this,
              e = { entity_id: b };
            if (c)
              switch (((e.master = this.entityId), d)) {
                case oc:
                ...
                case nc:
                  return this.callService(
                    a,
                    "sync",
                    { entity_id: this.entityId, other_player: b },
                    nc
                  );
                default:
              ...
              return d === oc
                ...
                : d === nc
                ? this.callService(a, "unsync", e, nc)
          ...
          toggleScript(a, b) {
            var c =
              2 < arguments.length && arguments[2] !== void 0
                ? arguments[2]
                : {};
            this.callService(a, b.split(".").pop(), Va({}, c), "script");
          }
          toggleService(a, b) {
            var c =
              2 < arguments.length && arguments[2] !== void 0
            ...
            a.stopPropagation();
            var [d, e] = b.split(".");
            this.hass.callService(d, e, Va({}, c));
          }
          callService(a, b, c) {
            var d =
            ...
            a.stopPropagation(),
              this.hass.callService(
                d,
                b,
                Va(Va({}, !e && { entity_id: this.entityId }), c)
              );
          }
        }
        var sc = Xb(Sa()),
          ...
          vc = (a, b, c) => {
            var d = [a, b, c].map((a) => {
              ...
              return (
                (b /= 255),
                0.03928 >= b ? b / 12.92 : ((b + 0.055) / 1.055) ** 2.4
              );
            });
            ...
            Ta(
              100 *
                (((a, b) => {
                  var c = vc(...a),
                    d = vc(...b);
                  return (Wa(c, d) + 0.05) / (Ua(c, d) + 0.05);
                })(a, b) +
                  Number.EPSILON)
            ) / 100,
          xc = (a) => {
            function b(a) {
              return e.has(a) || e.set(a, wc(d.rgb, a.rgb)), 4.5 < e.get(a);
            }
            a.sort((a, b) => b.population - a.population);
            for (
              var c, d = a[0], e = new Map(), f = 1;
              f < a.length && void 0 === c;
              f += 1
            ) {
              if (b(a[f])) {
              ...
              for (var g, h = a[f], i = f + 1; i < a.length; i += 1)
                if (
                  ((g = a[i]),
                  150 >=
                    Xa(h.rgb[0] - g.rgb[0]) +
            ...
            return void 0 === c && (c = d.bodyTextColor), [c, d.hex];
          };
        $a(186);
        var yc = {
            en: {
            ...
            fr: {
              placeholder: { tts: "Texte \xE0 lire" },
              label: {
                leave: "Quitter",
            ...
            hu: {
              placeholder: { tts: "Sz\xF6vegfelolvas\xE1s" },
              label: {
                leave: "Kil\xE9p\xE9s",
                ungroup: "\xD6sszes ki",
                group_all: "\xD6sszes be",
                send: "K\xFCld\xE9s",
                master: "Forr\xE1s",
              },
              state: { idle: "T\xE9tlen", unavailable: "Nem el\xE9rhet\u0151" },
              title: {
                speaker_management: "Hangsz\xF3r\xF3k csoportos\xEDt\xE1sa",
              },
            },
            no: {
            ...
            cz: {
              ...
              state: { idle: "Ne\u010Dinn\xFD", unavailable: "Nedostupn\xFD" },
              title: { speaker_management: "Spr\xE1va skupin" },
            },
          },
          zc = (a, b) => b.split(".").reduce((a, b) => (a && a[b]) || null, a),
          Ac = function (a, b, c) {
            var d =
                3 < arguments.length && arguments[3] !== void 0
                  ? arguments[3]
                  : "unknown",
              e = a.selectedLanguage || a.language;
            return (
              (yc[e] && zc(yc[e], b)) ||
              (a.resources[e] && a.resources[e][c]) ||
              zc(yc.en, b) ||
              d
            );
          };
        customElements.define(
            ...
            class extends Zb {
              ...
              render() {
                return Jb(
                  ...
                  this.handleClick,
                  this.item.name,
                  this.master ? Jb(Na(), Ac(this.hass, "label.master")) : ""
                );
              }
              handleClick(a) {
                a.stopPropagation(),
          ...
          customElements.define(
            ...
            class extends Zb {
              ...
              render() {
                if (!this.visible) return Jb(Ja());
                var { group: a, isMaster: b, isGrouped: c } = this,
                  { id: d } = this.player;
                return Jb(
                  Ia(),
                  Ac(this.hass, "title.speaker_management"),
                  this.entities.map((a) => this.renderItem(a, d)),
                  !c,
                  (a) => this.player.handleGroupChange(a, d, !1),
                  Ac(this.hass, "label.leave"),
                  c && b
                    ? Jb(
                        Ha(),
                        (b) => this.player.handleGroupChange(b, a, !1),
                        Ac(this.hass, "label.ungroup")
                      )
                    : Jb(Ga()),
                  !b,
                  (a) =>
            ...
            class extends Zb {
              ...
              render() {
                return Jb(
                  ...
                  this.icon
                    ? Jb(Ca(), fc)
                    : Jb(Ba(), this.selected || this.label, fc),
                  this.selectedId,
                  this.onChange,
                  this.items.map((a) =>
                    Jb(
          ...
          customElements.define(
            ...
            class extends Zb {
              ...
              get list() {
                var a;
                this.shortcuts.list = [];
                var b = Object.keys(this.hass.states);
                for (a = 0; a < b.length; a += 1)
                  if (
                    b[a].startsWith("media_player.") &&
                    "" !== this.hass.states[b[a]].entity_id
                  ) {
                    var c = this.hass.states[b[a]].attributes;
                    this.shortcuts.list.push({
                      name: c.friendly_name,
                      icon: "mdi:speaker",
                      id: "ais_exo_player.redirect_media",
                      type: "service",
                      data: { entity_id: this.hass.states[b[a]].entity_id },
                    });
                  }
              ...
              handleShortcut(a, b) {
                ...
                if ("add_ais_player" === c)
                  return this.player.addAisPlayer(a, d, e);
            ...
            class extends Zb {
              ...
              render() {
                return Jb(
                  na(),
                  this.label,
                  this.handleTtsKeyPres,
                  (a) => a.stopPropagation(),
                  this.handleTts,
                  Ac(this.hass, "label.send")
                );
              }
              validURL(a) {
              ...
              handleTtsKeyPres(a) {
                return 13 === a.charCode
                  ? void this.handleTts(a)
                  : (a.stopPropagation(), !0);
              }
              handleTts(a) {
                ...
                b.language && (d.language = b.language),
                  "alexa" === b.platform
                    ...
                    : this.hass.callService("tts", b.platform + "_say", d),
                  a.stopPropagation();
              }
              reset() {
                this.input.value = "";
        ...
        customElements.define(
          ...
          class extends Zb {
            ...
            render() {
              return Jb(
                ...
                this.showTime
                  ? Jb(
                      ka(),
                      Bc(this.seekProgress || this.progress),
                      Bc(this.duration)
                    )
                  : "",
                this.classes,
            ...
            connectedCallback() {
              super.connectedCallback(),
                this.hasProgress && this.trackProgress();
            }
            calcProgress(a) {
              var b = (a / this.seekWidth) * this.duration;
              return Ua(Wa(b, 0.1), this.duration);
            }
            static get styles() {
              return Xb(ja());
            }
            ...
            class extends Zb {
              ...
              render() {
                ...
                return Jb(
                  ...
                  a.volume
                    ? Jb(da())
                    : this.renderVolControls(this.player.muted),
                  this.showShuffle
                    ? Jb(
                        ca(),
                  ...
                  a.controls
                    ...
                    : Jb(
                        ...
                        !a.prev && this.player.supportsPrev
                          ? Jb(
                              $(),
                        ...
                        !a.next && this.player.supportsNext
                          ? Jb(Z(), (a) => this.player.next(a), hc)
                          : ""
                      )
                );
              }
              renderVolControls(a) {
                var b = this.config.volume_stateless
                  ...
                  d = !this.config.hide.volume_level;
                return Jb(Y(), c, b, d ? this.renderVolLevel() : "");
              }
              renderVolSlider(a) {
                return Jb(
                  X(),
                  ...
                  switch (this.config.replace_mute) {
                    ...
                    case "play_pause":
                      return Jb(
                        ...
                        ic[this.player.isPlaying]
                      );
                    case "stop":
                      return Jb(T(), (a) => this.player.stop(a), jc.true);
                    case "play_stop":
                      return Jb(
                        S(),
                        (a) => this.player.playStop(a),
                        jc[this.player.isPlaying]
                      );
                    case "next":
                      return Jb(R(), (a) => this.player.next(a), hc);
                    default:
                      return this.player.supportsMute
                        ? Jb(Q(), (a) => this.player.toggleMute(a), gc[a])
                        : void 0;
                  }
              }
              renderPlayButtons() {
                ...
                return Jb(
                  ...
                  a.play_stop
                    ...
                    : Jb(
                        L(),
                        (a) => this.handleStop(a),
                        a.play_pause ? jc[this.player.isPlaying] : jc.true
                      )
                );
              }
              handleStop(a) {
          ...
          customElements.define(
            ...
            class extends Zb {
              ...
              get icon() {
                return this.config.speaker_group.icon || "mdi:speaker-multiple";
              }
              get showGroupButton() {
              ...
              get hasSource() {
                return (
                  0 < this.player.sources.length && !this.config.hide.source
                );
              }
              get hasSoundMode() {
                return (
                  0 < this.player.soundModes.length &&
                  !this.config.hide.sound_mode
                );
              }
              get showLabel() {
              ...
              render() {
                return this.player.isUnavailable && this.showLabel
                  ...
                  : Jb(
                      ...
                      this.hasControls ? Jb(H(), this.player, this.config) : "",
                      this.hasSource
                        ? Jb(
                            G(),
                            this.player,
              ...
              get renderIdleView() {
                return this.player.isPaused
                  ? Jb(B(), ic[this.player.isPlaying], (a) =>
                      this.player.playPause(a)
                    )
                  : this.showLabel
                  ? Jb(
                      A(),
                      Ac(this.hass, "state.idle", "state.media_player.idle")
                    )
                  : Jb(z());
              }
              static get styles() {
        ...
        var Cc = ["cover", "full-cover", "material", "cover-fit", "none"],
          Dc = ["icon", "full"],
          Ec = ["icon", "full"],
          Fc = ["short", "scroll"],
          Gc = ["play_pause", "stop", "play_stop", "next"];
        customElements.define(
          ...
          class extends Zb {
            ...
            setConfig(a) {
              this._config = Object.assign({}, pc, a);
            }
            get getMediaPlayerEntities() {
              return Object.keys(this.hass.states).filter(
                (a) => "media_player" === a.substr(0, a.indexOf("."))
              );
            }
            get _group() {
            ...
            render() {
              return this.hass
                ? Jb(
                    ...
                    "entity",
                    this.valueChanged,
                    this.getMediaPlayerEntities.indexOf(this._config.entity),
                    this.getMediaPlayerEntities.map((a) => Jb(w(), a)),
                    this._config.name,
                    "name",
                    this.valueChanged,
                    this._config.icon,
                    ...
                    "artwork",
                    this.valueChanged,
                    Object.values(Cc).indexOf(this._config.artwork),
                    Object.values(Cc).map((a) => Jb(v(), a)),
                    "source",
                    this.valueChanged,
                    Object.values(Dc).indexOf(this._config.source),
                    Object.values(Dc).map((a) => Jb(u(), a)),
                    "sound_mode",
                    this.valueChanged,
                    Object.values(Ec).indexOf(this._config.sound_mode),
                    Object.values(Ec).map((a) => Jb(s(), a)),
                    "info",
                    this.valueChanged,
                    Object.values(Fc).indexOf(this._config.info),
                    Object.values(Fc).map((a) => Jb(r(), a)),
                    "replace_mute",
                    this.valueChanged,
                    Object.values(Gc).indexOf(this._config.replace_mute),
                    Object.values(Gc).map((a) => Jb(q(), a)),
                    this._config.volume_step,
                    "volume_step",
                    this.valueChanged,
                    this._config.max_volume,
                    "max_volume",
                    this.valueChanged,
                    this._config.min_volume,
                    "min_volume",
                    this.valueChanged,
                    this._config.idle_view,
                    "idle_view",
                    this.valueChanged,
            ...
            valueChanged(a) {
              if (this._config && this.hass) {
                var { target: b } = a;
                this["_" + b.configValue] !== b.value &&
                  (b.configValue &&
                    ("" === b.value
                      ? delete this._config[b.configValue]
                      : (this._config = Va(
                          Va({}, this._config),
                          {},
                          {
                            [b.configValue]:
                              void 0 === b.checked ? b.value : b.checked,
                          }
                        ))),
                  (function (a, b) {
                    var c =
          ...
          customElements.define(
            ...
            class extends Zb {
                ...
                if (a) {
                  ...
                  (this._hass = a),
                    b &&
                      this.entity !== b &&
                      ((this.entity = b),
                      (this.player = new rc(a, this.config, b)),
                      (this.rtl = this.computeRTL(a)),
                      (this.idle = this.player.idle),
                      this.player.trackIdle && this.updateIdleStatus());
                  var c,
                    d = Object.keys(a.states);
                  for (
                    this.ais_speaker_group_entities = [], c = 0;
                    c < d.length;
                    c += 1
                  )
                    if (d[c].startsWith("media_player.")) {
                      var e = a.states[d[c]].attributes;
                      this.ais_speaker_group_entities.push({
                        entity_id: a.states[d[c]].entity_id,
              ...
              renderArtwork() {
                if (this.thumbnail && "default" !== this.config.artwork) {
                  var a = {
                  ...
                  return Jb(k(), cc(a), this.prevThumbnail && Jb(j(), cc(b)));
                }
              }
              renderGradient() {
                if ("material" === this.config.artwork) {
                  var a = {
                    backgroundImage: "linear-gradient(to left,\n        transparent 0,\n        "
                      .concat(this.backgroundColor, " ")
                      .concat(this.cardHeight, "px,\n        ")
                      .concat(this.backgroundColor, " 100%)"),
                  };
                  return Jb(i(), cc(a));
                }
              }
              ...
              handlePopup(a) {
                a.stopPropagation(),
                  ((a, b, c, d, e) => {
                    ...
                    switch (d.action) {
                      case "more-info":
                        (f = new Event("hass-more-info", { composed: !0 })),
                          (f.detail = { entityId: d.entity || e }),
                          a.dispatchEvent(f);
                        break;
                      case "navigate":
                        if (!d.navigation_path) return;
                        window.history.pushState(null, "", d.navigation_path),
                          (f = new Event("location-changed", { composed: !0 })),
                          (f.detail = { replace: !1 }),
              ...
              renderIcon() {
                if (!this.config.hide.icon) {
                  ...
                  var a = !this.config.hide.icon_state && this.player.isActive;
                  return Jb(f(), a, this.computeIcon());
                }
              }
              renderEntityName() {
                if (!this.config.hide.name)
                  return Jb(e(), this.name, this.speakerCount());
              }
              renderMediaInfo() {
                  ...
                  return Jb(
                    ...
                    "scroll" === this.config.info
                      ? Jb(
                          c(),
                          e.map((a) =>
                            Jb(b(), "attr__" + a.attr, a.prefix + a.text)
                          )
                        )
                      : "",
                    e.map((b) => Jb(a(), "attr__" + b.attr, b.prefix + b.text))
                  );
                }
              }
              speakerCount() {
                if (this.config.speaker_group.show_group_count) {
                  var a = this.groupMgmtPlayer
              ...
              computeArtwork() {
                var a = this;
                return Ya(function* () {
                  var { picture: b, hasArtwork: c } = a.player;
                  if (c && b !== a.picture) {
                    a.picture = b;
                    var d = yield a.player.fetchArtwork();
                    a.thumbnail && (a.prevThumbnail = a.thumbnail),
                      (a.thumbnail = d || "url(".concat(b, ")"));
                  }
                })();
              }
              computeIcon() {
                return this.config.icon ? this.player.icon : "mdi:cast";
              }
              measureCard() {
                var a = this.shadowRoot.querySelector("ha-card");
                a && (this.cardHeight = a.offsetHeight);
              }
              computeOverflow() {
              ...
              computeRect(a) {
                var { left: b, width: c } =
                  a.contentRect || a.getBoundingClientRect();
                this.break = 390 > c + 2 * b;
              }
              computeRTL(a) {
                var b = a.language || "en";
                return (
                  (a.translationMetadata.translations[b] &&
                    a.translationMetadata.translations[b].isRTL) ||
                  !1
                );
              }
              toggleGroupList() {
              ...
              updateIdleStatus() {
                ...
                var a =
                  (Date.now() - new Date(this.player.updatedAt).getTime()) /
                  1e3;
              ...
              setColors() {
                var a = this;
                return Ya(function* () {
                  if (a.player.picture !== a.picture) {
                    if (!a.player.picture)
                      return (
                        (a.foregroundColor = ""), void (a.backgroundColor = "")
                      );
                    try {
                      [a.foregroundColor, a.backgroundColor] = yield ((b =
                        a.player.picture),
                      new uc(b, {
                        colorCount: 16,
                        generator: xc,
                      ...
                      console.error("Error getting Image Colors", b),
                        (a.foregroundColor = ""),
                        (a.backgroundColor = "");
                    }
                    var b;
