  ...
  protected render(): TemplateResult {
    ...
    return html`
      <ha-dialog
        open
        hideActions
        .heading=${createCloseHeading(this.hass, "Sprawdzenie zródła audio")}
        @closed=${this.closeDialog}
      >
      <h3>Obecnie odtwarzasz ze adresu: </h3>
       ${this._aisMediaInfo?.attributes["media_content_id"]} 
      <p>Jeżeli jest problem z tym zasobem, to możesz automatycznie sprawdzić, czy jest dostępne bardziej aktualne źródło tego audio.</p>
